...
//
// Most flags are defined in DevjsFeatureFlags. If it's defined there, you don't
...
function getTestFlags() {
  ...
  const featureFlags = require('shared/DevjsFeatureFlags');
  ...
  return new Proxy(
    {
      ...
      // If there's a naming conflict between scheduler and Devjs feature flags, the
      // Devjs ones take precedence.
