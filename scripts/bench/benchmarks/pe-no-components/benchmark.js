(function () {
  ...
  var DevjsImage0 = function (x) {
    if (x === 0) {
      return Devjs.createElement('i', {
        alt: '',
    ...
    if (x === 42) {
      return Devjs.createElement(
        ...
        Devjs.createElement('u', null, 'Warning')
      );
    }
    if (x === 67) {
      return Devjs.createElement('i', {
      ...
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          Devjs.createElement(
            'span',
            null,
            Devjs.createElement('span', {className: '_48u-'}, 'Account:'),
            ' ',
    ...
    if (x === 303) {
      return Devjs.createElement(
        ...
        Devjs.createElement(
          'div',
          null,
          Devjs.createElement('div', {className: '_tma'}),
          Devjs.createElement('div', {className: '_tm8'}),
          Devjs.createElement('div', {className: '_tm9'}, 1)
        ),
        undefined
      );
    }
  ...
  var DevjsXUIPopoverButton6 = function (x) {
    if (x === 6) {
  ...
  var BIGAdAccountSelector7 = function (x) {
    if (x === 7) {
      return Devjs.createElement('div', null, DevjsXUIPopoverButton6(6), null);
    }
  };
  ...
  var AdsPENavigationBar11 = function (x) {
    if (x === 11) {
      return Devjs.createElement('div', {className: '_4t_9'});
    }
  };
  ...
  var AdsPEDraftSyncStatus13 = function (x) {
    if (x === 16) {
      return Devjs.createElement(
        ...
        Devjs.createElement('span', {className: '_3uu0'}, DevjsImage0(15))
      );
    }
  };
  ...
  var InlineBlock19 = function (x) {
    ...
    if (x === 273) {
      return Devjs.createElement(
        ...
        DevjsXUIPopoverButton6(272)
      );
    }
  };

  var DevjsPopoverMenu20 = function (x) {
    if (x === 31) {
      ...
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          Devjs.createElement(
            'div',
            {className: '_42ef'},
            Devjs.createElement('div', {className: '_2oc7'}, 'Auction')
          )
        )
      );
    }
  ...
  var AdsUnifiedNavigationLocalNav22 = function (x) {
    if (x === 35) {
      return Devjs.createElement('div', {className: '_34_i'}, LeftRight21(34));
    }
  };
  ...
  var AdsPEResetDialog24 = function (x) {
    if (x === 37) {
      return Devjs.createElement('span', null, XUIDialog23(36));
    }
  };
  ...
  var DevjsCSSTransitionGroupChild31 = function (x) {
    if (x === 52) {
      return XUINotice30(51);
    }
  };

  var DevjsTransitionGroup32 = function (x) {
    if (x === 53) {
      return Devjs.createElement(
        'span',
        null,
        DevjsCSSTransitionGroupChild31(52)
      );
    }
  };

  var DevjsCSSTransitionGroup33 = function (x) {
    if (x === 54) {
      return DevjsTransitionGroup32(53);
    }
  };
    ...
    if (x === 66) {
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          null,
          null,
          Devjs.createElement('div', {className: '_3c5i'}),
          null
        )
      );
    }
  ...
  var AdsPEFiltersPopover58 = function (x) {
    if (x === 144) {
      return Devjs.createElement(
        ...
        DevjsXUIPopoverButton6(133),
        DevjsXUIPopoverButton6(141),
    ...
    if (x === 154) {
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          Devjs.createElement('span', {className: '_3o_j'}),
          DevjsImage0(153)
        ),
        null
      );
      ...
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          Devjs.createElement(
            ...
            DevjsImage0(148),
            Devjs.createElement('div', {className: '_3yz7'}, 'Campaigns:'),
            Devjs.createElement(
              'div',
              {
  ...
  var BUIFilterTokenCreateButton66 = function (x) {
    if (x === 163) {
      return Devjs.createElement('div', {className: '_1tc'}, XUIButton4(162));
    }
  };
  ...
  var BUIFilterTokenizer67 = function (x) {
    if (x === 164) {
      return Devjs.createElement(
        ...
        null,
        Devjs.createElement('div', {className: '_49u3'})
      );
    }
  };
  ...
  var AdsPEFilters71 = function (x) {
    if (x === 168) {
      return Devjs.createElement(
        ...
        Devjs.createElement('div', {className: '_1eo'}, InputLabel61(147)),
  ...
  var DevjsXUIError76 = function (x) {
    if (x === 181) {
  ...
  var BUIPopoverButton77 = function (x) {
    if (x === 182) {
      return DevjsXUIError76(181);
    }
  };

  var BUIDateRangePicker78 = function (x) {
    if (x === 184) {
      return Devjs.createElement('span', null, BUIPopoverButton77(182), [
        Constructor49(183),
      ]);
    }
  };
  ...
  var AdsPEStatRange80 = function (x) {
    if (x === 191) {
      return Devjs.createElement(
        'div',
        {className: '_3c5k'},
        Devjs.createElement('span', {className: '_3c5j'}, 'Stats:'),
        Devjs.createElement(
          'span',
          {className: '_3c5l'},
  ...
  var AdsPESideTrayTabButton82 = function (x) {
    if (x === 196) {
      return Devjs.createElement(
        ...
        DevjsImage0(195),
        Devjs.createElement('div', {className: '_vf7'}),
        Devjs.createElement('div', {className: '_vf8'})
      );
    }
    if (x === 199) {
      return Devjs.createElement(
  ...
  var AdsPEEditorChildLink86 = function (x) {
    if (x === 211) {
      return Devjs.createElement(
        ...
        {className: '_3ywr'},
        Link2(208),
        Devjs.createElement('span', {className: '_3ywq'}, '|'),
        Link2(210)
      );
    }
  };
  ...
  var AdsPEHeaderSection88 = function (x) {
    if (x === 213) {
      return Devjs.createElement(
        'div',
        {className: '_yke'},
        Devjs.createElement('div', {className: '_2x9d _pr-'}),
        XUIText29(205),
        Devjs.createElement(
          'div',
          {className: '_3a-a'},
          Devjs.createElement('div', {className: '_3a-b'}, XUIText29(206))
        ),
  ...
  var AdsCard95 = function (x) {
    if (x === 222) {
      return DevjsXUIError76(221);
    }
    if (x === 251) {
      return DevjsXUIError76(250);
    }
    if (x === 281) {
      return DevjsXUIError76(280);
    }
  };
  ...
  var XUICardHeaderTitle100 = function (x) {
    if (x === 227) {
      return Devjs.createElement(
        ...
        'Campaign Details',
        null,
        Devjs.createElement('span', {className: '_c1c'})
      );
    }
    if (x === 265) {
      return Devjs.createElement(
  ...
  var XUICardSection101 = function (x) {
    if (x === 228) {
      return Devjs.createElement(
        ...
        undefined,
        undefined,
        Devjs.createElement('div', {className: '_3s3-'})
      );
    }
    if (x === 247) {
      return Devjs.createElement(
  ...
  var AdsLabeledField104 = function (x) {
    if (x === 231) {
      return Devjs.createElement(
        ...
        null,
        Devjs.createElement('div', {className: '_3bv-'})
      );
    }
    if (x === 234) {
      return Devjs.createElement(
  ...
  var AdsStickyArea114 = function (x) {
    if (x === 259) {
      return Devjs.createElement(
        'div',
        {},
        Devjs.createElement('div', {onWheel: function () {}})
      );
    }
    if (x === 292) {
      return Devjs.createElement(
    ...
    if (x === 261) {
      return Devjs.createElement(
        ...
        Devjs.createElement(
          ...
          Devjs.createElement('div', {className: '_128p'})
        ),
        null
      );
    }
  ...
  var AdsLinksMenu120 = function (x) {
    if (x === 275) {
      return DevjsPopoverMenu20(274);
    }
  };

  var FluxContainer_AdsPluginizedLinksMenuContainer_121 = function (x) {
    if (x === 276) {
      return Devjs.createElement('div', null, null, AdsLinksMenu120(275));
    }
  };
  ...
  var AdsPEOrganizerContainer139 = function (x) {
    if (x === 310) {
      return Devjs.createElement('div', null, AdsPESimpleOrganizer138(309));
    }
  };
  ...
  var FixedDataTableColumnResizeHandle140 = function (x) {
    if (x === 313) {
      return Devjs.createElement(
        ...
        Devjs.createElement('div', {className: '_348a', style: {height: 25}})
      );
    }
  };
  ...
  var AdsPETableHeader141 = function (x) {
    if (x === 315) {
      return Devjs.createElement(
        ...
        DevjsImage0(314),
        Devjs.createElement('span', {className: '_1cid'}, 'Campaigns')
      );
    }
    if (x === 320) {
      return Devjs.createElement(
        ...
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Performance')
      );
    }
    if (x === 323) {
      return Devjs.createElement(
        ...
        {className: '_1cig _1vd7 _4h2r', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Overview')
      );
    }
    if (x === 326) {
      return Devjs.createElement(
        ...
        {className: '_1cig _1vd7 _4h2r', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Toplines')
      );
    }
    if (x === 329) {
    ...
    if (x === 340) {
      return Devjs.createElement(
        ...
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Campaign Name')
      );
    }
    if (x === 346) {
      return Devjs.createElement(
    ...
    if (x === 357) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Status')
      );
    }
    if (x === 362) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Delivery')
      );
    }
    if (x === 369) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Results')
      );
    }
    if (x === 374) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Cost')
      );
    }
    if (x === 379) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Reach')
      );
    }
    if (x === 384) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Impressions')
      );
    }
    if (x === 389) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Clicks')
      );
    }
    if (x === 394) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Avg. CPM')
      );
    }
    if (x === 399) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Avg. CPC')
      );
    }
    if (x === 404) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'CTR %')
      );
    }
    if (x === 409) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Spent')
      );
    }
    if (x === 414) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Objective')
      );
    }
    if (x === 419) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Buying Type')
      );
    }
    if (x === 424) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Campaign ID')
      );
    }
    if (x === 429) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Start')
      );
    }
    if (x === 434) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'End')
      );
    }
    if (x === 439) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Date created')
      );
    }
    if (x === 444) {
      return Devjs.createElement(
        ...
        {className: '_1cig _25fg', id: undefined},
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Date last edited')
      );
    }
    if (x === 449) {
      return Devjs.createElement(
        ...
        null,
        Devjs.createElement('span', {className: '_1cid'}, 'Tags')
      );
    }
    if (x === 452) {
      return Devjs.createElement('div', {
  ...
  var AdsBugReportContainer166 = function (x) {
    if (x === 481) {
      return Devjs.createElement('span', null);
    }
  };
  ...
  var AdsPEContainer181 = function (x) {
    if (x === 496) {
      return Devjs.createElement(
        ...
        Devjs.createElement('div', {id: 'web_ads_guidance_tips'})
      );
    }
  };
