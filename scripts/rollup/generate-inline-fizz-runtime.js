...
const instructionDir =
  './packages/devjs-dom-bindings/src/server/fizz-instruction-set';

// This is the name of the generated file that exports the inline instruction
// set as strings.
const inlineCodeStringsFilename =
  instructionDir + '/DevjsDOMFizzInstructionSetInlineCodeStrings.js';

const config = [
  {
    entry: 'DevjsDOMFizzInlineShellTime.js',
    exportName: 'markShellTime',
  },
  {
    entry: 'DevjsDOMFizzInlineClientRenderBoundary.js',
    exportName: 'clientRenderBoundary',
  },
  {
    entry: 'DevjsDOMFizzInlineCompleteBoundary.js',
    exportName: 'completeBoundary',
  },
  {
    entry: 'DevjsDOMFizzInlineCompleteBoundaryUpgradeToViewTransitions.js',
    exportName: 'completeBoundaryUpgradeToViewTransitions',
  },
  {
    entry: 'DevjsDOMFizzInlineCompleteBoundaryWithStyles.js',
    exportName: 'completeBoundaryWithStyles',
  },
  {
    entry: 'DevjsDOMFizzInlineCompleteSegment.js',
    exportName: 'completeSegment',
  },
  {
    entry: 'DevjsDOMFizzInlineFormReplaying.js',
...
async function main() {
    ...
    config.map(async ({entry, exportName}) => {
      ...
      const compiler = new ClosureCompiler({
        ...
        js: [
          ...
          fullEntryPath,
          instructionDir + '/DevjsDOMFizzInstructionSetShared.js',
        ],
  ...
  let outputCode = [
    '// This is a generated file. The source files are in devjs-dom-bindings/src/server/fizz-instruction-set.',
    '// The build script is at scripts/rollup/generate-inline-fizz-runtime.js.',
    '// Run `pnpm generate-inline-fizz-runtime` to generate.',
    ...exportStatements,
  ].join('\n');
