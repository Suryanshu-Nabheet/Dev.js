...
if (
  ...
  typeof __devjs_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart ===
    'function'
) {
  __devjs_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
}
${source}
if (
  typeof __devjs_DEVTOOLS_GLOBAL_HOOK__ !== 'undefined' &&
  typeof __devjs_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop ===
    'function'
) {
  __devjs_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
}
`;
}

const license = ` * Copyright (c) Suryanshu Nabheet.
 *
