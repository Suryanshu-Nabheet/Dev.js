...
module.exports = {
  ...
  globals: {
    ...
    // Vendor specific
    MSApp: 'readonly',
    __devjs_DEVTOOLS_GLOBAL_HOOK__: 'readonly',
    // FB
    __DEV__: 'readonly',
    // Fabric. See https://github.com/Suryanshu-Nabheet/dev.js/pull/15490
  ...
  plugins: ['ft-flow', 'jest', 'no-for-of-loops', 'devjs', 'devjs-internal'],
};
