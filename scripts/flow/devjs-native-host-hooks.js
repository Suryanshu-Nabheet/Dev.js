...
// from 'devjs-native-renderer/src/DevjsNativeTypes'
...
type __DevjsNativeBaseComponentViewConfig = any;
...
// from 'devjs-native-renderer/src/legacy-events/TopLevelEventTypes';
type __RNTopLevelEventType = any;

// libdefs cannot actually import. This is supposed to be the type imported
// from 'devjs-reconciler/src/DevjsCapturedValue'
...
declare module 'devjs-native/Libraries/DevjsPrivate/DevjsNativePrivateInterface' {
  ...
  declare export const DevjsFiberErrorDialog: {
  ...
  declare export const UIManager: {
    ...
    manageChildren: (
      ...
      addChildDevjsTags: Array<number>,
    ...
    setChildren: (containerTag: number, devjsTags: Array<number>) => void,
    updateView: (devjsTag: number, viewName: string, props: ?Object) => void,
    __takeSnapshot: (
    ...
    setJSResponder: (devjsTag: number, blockNativeResponder: boolean) => void,
  ...
  declare export const DevjsNativeViewConfigRegistry: {
    customBubblingEventTypes: Object,
    customDirectEventTypes: Object,

    register: (name: string, callback: __ViewConfigGetter) => string,
    get: (name: string) => __DevjsNativeBaseComponentViewConfig,
    ...
  };
...
declare module 'devjs-native/Libraries/DevjsPrivate/DevjsNativePrivateInitializeCore' {
}

declare module 'devjs-native' {
...
declare const RN$enableMicrotasksInDevjs: boolean;

// This is needed for a short term solution.
// See https://github.com/Suryanshu-Nabheet/dev.js/pull/15490 for more info
// eslint-disable-next-line no-unused-vars
