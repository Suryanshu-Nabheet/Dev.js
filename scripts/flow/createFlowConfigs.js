...
function writeConfig(
  ...
  const forks = new Map();
  addFork(forks, renderer, 'devjs-reconciler/src/DevjsFiberConfig');
  addFork(forks, serverRenderer, 'devjs-server/src/DevjsServerStreamConfig');
  addFork(forks, serverRenderer, 'devjs-server/src/DevjsFizzConfig');
  addFork(forks, flightRenderer, 'devjs-server/src/DevjsFlightServerConfig');
  addFork(forks, flightRenderer, 'devjs-client/src/DevjsFlightClientConfig');
  forks.set(
    'devjs-devtools-shared/src/config/DevToolsFeatureFlags.default',
    'devjs-devtools-feature-flags',
  );
  ...
  const config = configTemplate
    .replace('%devjs_RENDERER_FLOW_OPTIONS%', moduleMappings.trim())
    .replace('%devjs_RENDERER_FLOW_IGNORES%', ignoredPaths.join('\n'))
