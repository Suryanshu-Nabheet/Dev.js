...
declare const __devjs_DEVTOOLS_GLOBAL_HOOK__: any; /*?{
  inject: ?((stuff: Object) => void)
};*/

declare const reportError: (error: mixed) => void;

declare module 'create-devjs-class' {
...
// Flow hides the props of Devjs$Element, this overrides it to unhide
// them for Devjs internals.
// $FlowFixMe[libdef-override]
declare opaque type Devjs$Element<
  +ElementType: Devjs$ElementType,
  +P = Devjs$ElementProps<ElementType>,
>: {
  +type: ElementType,
  +props: P,
  +key: Devjs$Key | null,
...
declare type Devjs$CustomJSXFactory = any;
...
// DevjsFeatureFlags www fork
declare module 'DevjsFeatureFlags' {
  declare module.exports: any;
}

// DevjsFiberErrorDialog www fork
declare module 'DevjsFiberErrorDialog' {
