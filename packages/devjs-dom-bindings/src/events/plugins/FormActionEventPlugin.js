...
import {enableTrustedTypesIntegration} from 'shared/DevjsFeatureFlags';
import {getFiberCurrentPropsFromNode} from '../../client/DevjsDOMComponentTree';
import {startHostTransition} from 'devjs-reconciler/src/DevjsFiberReconciler';
import {didCurrentEventScheduleTransition} from 'devjs-reconciler/src/DevjsFiberRootScheduler';
import sanitizeURL from 'devjs-dom-bindings/src/shared/sanitizeURL';
...
function coerceFormActionProp(
  ...
  // This should match the logic in DevjsDOMComponent
  if (
    actionProp == null ||
