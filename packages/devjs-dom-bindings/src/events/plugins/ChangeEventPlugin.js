 ...
 * @flow
 */
import type {TextInstance, Instance} from '../../client/DevjsFiberConfigDOM';
...
import {getNodeFromInstance} from '../../client/DevjsDOMComponentTree';
import {updateValueIfChanged} from '../../client/inputValueTracking';
import {setDefaultValue} from '../../client/DevjsDOMInput';
import {enqueueStateRestore} from '../DevjsDOMControlledComponent';

import {disableInputAttributeSyncing} from 'shared/DevjsFeatureFlags';
...
function createAndAccumulateChangeEvent(
  ...
  if (listeners.length > 0) {
    const event: DevjsSyntheticEvent = new SyntheticEvent(
      'onChange',
      'change',
      null,
      nativeEvent,
...
function manualDispatchChangeEvent(nativeEvent: AnyNativeEvent) {
  ...
  // other events and have it go through DevjsBrowserEventEmitter. Since it
  ...
  // handlers can run. See https://github.com/Suryanshu-Nabheet/dev.js/issues/708.
