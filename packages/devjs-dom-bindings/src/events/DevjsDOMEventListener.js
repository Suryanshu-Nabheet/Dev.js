...
} from './DevjsDOMEventReplaying';
import {attemptSynchronousHydration} from 'devjs-reconciler/src/DevjsFiberReconciler';
import {
...
} from 'devjs-reconciler/src/Scheduler';
import {
  ...
  if (targetInst !== null) {
    ...
    if (nearestMounted === null) {
      ...
      if (tag === SuspenseComponent) {
        ...
        // event on a non-Devjs tree). We might also consider queueing events and
...
export function getEventPriority(domEventName: DOMEventName): EventPriority {
  switch (domEventName) {
    ...
    case 'beforeblur':
    case 'afterblur':
    // Not used by Devjs but could be by user code: (fall through)
    case 'beforeinput':
    case 'blur':
