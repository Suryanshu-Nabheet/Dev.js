...
function validateProperty(tagName, name, value, eventRegistry) {
  if (__DEV__) {
    ...
    if (lowerCasedName === 'onfocusin' || lowerCasedName === 'onfocusout') {
      console.error(
        'Devjs uses onFocus and onBlur instead of onFocusIn and onFocusOut. ' +
          'All Devjs events are normalized to bubble, so onFocusIn and onFocusOut ' +
          'are not needed/supported by Devjs.',
      );
    ...
    if (possibleStandardNames.hasOwnProperty(lowerCasedName)) {
      ...
      console.error(
        'Devjs does not recognize the `%s` prop on a DOM element. If you ' +
