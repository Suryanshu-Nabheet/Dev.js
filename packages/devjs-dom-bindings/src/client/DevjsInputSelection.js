...
import {getOffsets, setOffsets} from './DevjsDOMSelection';
...
/**
 * @DevjsInputSelection: Devjs input selection module. Based on Selection.js,
 * but modified to be suitable for devjs and has a couple of bug fixes (doesn't
 * assume buttons have range selections allowed).
 * Input selection module for Devjs.
 */
