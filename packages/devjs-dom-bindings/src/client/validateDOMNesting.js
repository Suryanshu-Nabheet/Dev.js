...
import type {HydrationDiffNode} from 'devjs-reconciler/src/DevjsFiberHydrationDiffs';
...
import {describeDiff} from 'devjs-reconciler/src/DevjsFiberHydrationDiffs';
...
// for cases where the parser will give a parse tree differing from what Devjs
      ...
      if (
        ...
        runWithFiberInDEV(ancestor, () => {
          console.error(
            ...
            // such as in Devjs DevTools or grouped server logs.
