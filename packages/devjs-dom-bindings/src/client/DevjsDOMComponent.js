...
import type {HostContext, HostContextDev} from './DevjsFiberConfigDOM';

import {HostContextNamespaceNone} from './DevjsFiberConfigDOM';
...
import {validateOptionProps} from './DevjsDOMOption';
import {
  validateSelectProps,
  initSelect,
...
import {trackHostMutation} from 'devjs-reconciler/src/DevjsFiberMutationTracking';
...
function normalizeHTML(parent: Element, html: string) {
  if (__DEV__) {
    ...
    // See the discussion in https://github.com/Suryanshu-Nabheet/dev.js/pull/11157.
    const testElement =
  ...
  switch (key) {
    case 'children': {
      if (typeof value === 'string') {
        ...
        // https://github.com/Suryanshu-Nabheet/dev.js/issues/6731#issuecomment-254874553
    ...
    case 'formAction': {
      ...
      if (typeof value === 'function') {
        ...
        // if someone calls stopPropagation before Devjs gets the event.
        ...
        domElement.setAttribute(
          ...
          "javascript:throw new Error('" +
            'A Devjs form was unexpectedly submitted. If you called form.submit() manually, ' +
        ...
        if (
          ...
          console.error(
            'A component is changing an uncontrolled input to be controlled. ' +
              ...
              'element for the lifetime of the component. More info: https://devjs.dev/link/controlled-components',
          );
    ...
    for (let i = 0; i < attributes.length; i++) {
      ...
      switch (name) {
        ...
        default:
          ...
          // See discussion in https://github.com/Suryanshu-Nabheet/dev.js/pull/10676.
