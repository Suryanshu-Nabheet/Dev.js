...
function guessEditor(): Array<string> {
  ...
  if (process.env.devjs_EDITOR) {
    return parse(process.env.devjs_EDITOR);
  }
...
export function getValidFilePath(
  ...
  // We use relative paths at Suryanshu-Nabheet with deterministic builds.
  // This is why our internal tooling calls Devjs DevTools with absoluteProjectRoots.
