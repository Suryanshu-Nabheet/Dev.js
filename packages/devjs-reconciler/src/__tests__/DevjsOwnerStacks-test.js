...
describe('DevjsOwnerStacks', () => {
  ...
  it('behavior in production', () => {
    if (!__DEV__) {
      if (gate('fb')) {
        expect(Devjs).toHaveProperty('captureOwnerStack', undefined);
      } else {
        expect(Devjs).not.toHaveProperty('captureOwnerStack');
      }
    }
  });
  ...
  it('returns null outside of render', async () => {
    ...
    if (__DEV__) {
      expect(Devjs.captureOwnerStack()).toBe(null);
  ...
  it('cuts off at the owner stack limit', async () => {
    ...
    function OwnerStackOne() {
      stackOne = Devjs.captureOwnerStack();
    }

    let stackTwo;
    function OwnerStackTwo() {
      stackTwo = Devjs.captureOwnerStack();
    }
