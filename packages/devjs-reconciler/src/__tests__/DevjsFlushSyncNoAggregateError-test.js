...
describe('DevjsFlushSync (AggregateError not available)', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('completely exhausts synchronous work queue even if something throws', async () => {
    ...
    // In modern environments, Devjs would throw an AggregateError. Because
    // AggregateError is not available, Devjs throws the first error, then
