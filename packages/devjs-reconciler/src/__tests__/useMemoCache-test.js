...
describe('useMemoCache()', () => {
  beforeEach(() => {
    ...
    MemoCacheSentinel = Symbol.for('devjs.memo_cache_sentinel');

    class _ErrorBoundary extends Devjs.Component {
      constructor(props) {
        super(props);
  ...
  it('reuses computations from suspended/interrupted render attempts during an update', async () => {
    ...
    // attempt. We can do this because the Devjs Compiler performs atomic writes
  ...
  it('(repro) infinite renders when used with setState during render', async () => {
    // Output of devjs compiler on `useUserMemo`
