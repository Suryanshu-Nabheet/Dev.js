...
describe('DevjsLazy', () => {
  ...
  it('suspends until module has loaded', async () => {
    ...
    const root = DevjsTestRenderer.create(
  ...
  it('renders a lazy context provider', async () => {
    ...
    function ConsumerText() {
      return <Text text={Devjs.useContext(Context)} />;
    }
  ...
  it('does not support arbitrary promises, only module objects', async () => {
    ...
    const root = DevjsTestRenderer.create(null, {
      unstable_isConcurrent: true,
    });
  ...
  it('mount and reorder', async () => {
    ...
    const root = DevjsTestRenderer.create(<Parent swap={false} />, {
      unstable_isConcurrent: true,
    });
    ...
    await act(async () => {
      ...
      // TODO: Devjs.lazy should implement the `status` and `value` fields, so
  ...
  it('resolves defaultProps, on mount and update', async () => {
    class T extends Devjs.Component {
      render() {
  ...
  it('resolves defaultProps without breaking memoization', async () => {
    class LazyImpl extends Devjs.Component {
      render() {
        Scheduler.log('Lazy');
        return (
          <>
    ...
    const stateful = Devjs.createRef(null);
  ...
  it('resolves defaultProps without breaking bailout due to unchanged props and state, #17151', async () => {
    ...
    const instance1 = Devjs.createRef(null);
    const instance2 = Devjs.createRef(null);
  ...
  it('resolves defaultProps without breaking bailout in PureComponent, #17151', async () => {
    class LazyImpl extends Devjs.PureComponent {
      static defaultProps = {value: 0};
      state = {};
  ...
  it('throws with a useful error when wrapping Fragment with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.Fragment));
    ...
    await resolveFakeImport(Devjs.Fragment);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping createPortal with lazy()', async () => {
    ...
    const portal = DevjsDOM.createPortal(<div />, container);
  ...
  it('throws with a useful error when wrapping Profiler with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.Profiler));
    ...
    await resolveFakeImport(Devjs.Profiler);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping StrictMode with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.StrictMode));
    ...
    await resolveFakeImport(Devjs.StrictMode);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping Suspense with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.Suspense));
    ...
    await resolveFakeImport(Devjs.Suspense);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping SuspenseList with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.unstable_SuspenseList));
    ...
    await resolveFakeImport(Devjs.unstable_SuspenseList);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping ViewTransition with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.ViewTransition));
    ...
    await resolveFakeImport(Devjs.ViewTransition);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping Activity with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.Activity));
    ...
    await resolveFakeImport(Devjs.Activity);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping TracingMarker with lazy()', async () => {
    const BadLazy = lazy(() => fakeImport(Devjs.unstable_TracingMarker));
    ...
    await resolveFakeImport(Devjs.unstable_TracingMarker);
    root.update(
      <Suspense fallback={<Text text="Loading..." />}>
        <BadLazy />
      </Suspense>,
  ...
  it('throws with a useful error when wrapping lazy() multiple times', async () => {
    ...
    await waitForThrow(
      'Element type is invalid. Received a promise that resolves to: [object Object]. ' +
        'Lazy element type must resolve to a class or function.' +
        (__DEV__
          ? ' Did you wrap a component in Devjs.lazy() more than once?'
          : ''),
    );
  });
  ...
  it('resolves props for class component with defaultProps', async () => {
    class Add extends Devjs.Component {
      render() {
  ...
  it('resolves props for forwardRef component without defaultProps', async () => {
    const Add = Devjs.forwardRef((props, ref) => {
      return props.inner + props.outer;
    });
    Add.displayName = 'Add';
  ...
  it('supports class and forwardRef components', async () => {
    ...
    const ForwardRefBar = Devjs.forwardRef((props, ref) => {
