...
describe('DevjsLazyContextPropagation', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it(
    ...
    async () => {
      ...
      function App() {
        ...
        const consumer = Devjs.useMemo(() => <Consumer />, []);
  ...
  it('context is propagated across retries', async () => {
    ...
    const Context = Devjs.createContext('A');
  ...
  it('multiple contexts are propagated across retries', async () => {
    ...
    const Context1 = Devjs.createContext('A');
    const Context2 = Devjs.createContext('A');
    ...
    const Indirection1 = Devjs.memo(() => {
      // This child must always be consistent with the sibling Text component.
      return <DeepChild1 />;
    });

    const Indirection2 = Devjs.memo(() => {
      // This child must always be consistent with the sibling Text component.
      return <DeepChild2 />;
    });
  ...
  it('context is propagated through offscreen trees', async () => {
    const LegacyHidden = Devjs.unstable_LegacyHidden;
  ...
  it('nested bailouts', async () => {
    ...
    const ChildIndirection = Devjs.memo(() => {
      return <Child />;
    });
    ...
    const DeepChildIndirection = Devjs.memo(() => {
      return <DeepChild />;
    });
