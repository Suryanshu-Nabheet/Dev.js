...
describe('DevjsInteractionTracing', () => {
  ...
  it('should not call callbacks when transition is not defined', async () => {
    ...
    function App({navigate}) {
      return (
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name="marker">
              <Text text="Page Two" />
            </Devjs.unstable_TracingMarker>
          ) : (
            <Text text="Page One" />
          )}
        </div>
  ...
  it('should correctly trace basic interaction with tracing markers', async () => {
    ...
    function App() {
      ...
      return (
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name="marker two" key="marker two">
              <Text text="Page Two" />
            </Devjs.unstable_TracingMarker>
          ) : (
            <Devjs.unstable_TracingMarker name="marker one">
              <Text text="Page One" />
            </Devjs.unstable_TracingMarker>
          )}
        </div>
        ...
        <div>
          {navigate ? (
            <Suspense
              ...
              name="suspense page">
              <AsyncText text="Page Two" />
              <Devjs.unstable_TracingMarker name="sync marker" />
              <Devjs.unstable_TracingMarker name="async marker">
                <Suspense
                  fallback={<Text text="Loading..." />}
  ...
  it('trace interaction with multiple tracing markers', async () => {
    ...
    function App() {
      ...
      return (
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name="outer marker">
              <Suspense fallback={<Text text="Outer..." />} name="outer">
                ...
                <Suspense
                  ...
                  name="inner two">
                  <Devjs.unstable_TracingMarker name="marker two">
  ...
  it.skip('warn and calls marker incomplete if name changes before transition completes', async () => {
    ...
    function App({navigate, markerName}) {
      return (
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name={markerName}>
  ...
  it('marker incomplete for tree with parent and sibling tracing markers', async () => {
    ...
    function App({navigate, showMarker}) {
      return (
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name="parent">
              {showMarker ? (
                <Devjs.unstable_TracingMarker name="marker one">
                  <Suspense
                    name="suspense page"
              ...
              <Devjs.unstable_TracingMarker name="sibling">
                <Suspense
        ...
        <div>
          {navigate ? (
            <Devjs.unstable_TracingMarker name="parent">
              {!deleteOne ? (
                <div>
                  <Devjs.unstable_TracingMarker name="one">
                    <Suspense
                      name="suspense one"
              ...
              <Devjs.unstable_TracingMarker name="two">
                <Suspense
                  name="suspense two"
              ...
              <Devjs.unstable_TracingMarker name="one">
                {!deleteOne ? (
                  <Suspense
                    ...
                    fallback={<Text text="Loading One..." />}>
                    <AsyncText text="Page One" />
                    <Devjs.unstable_TracingMarker name="page one" />
                    <Suspense
                      name="suspense child"
                      fallback={<Text text="Loading Child..." />}>
                      <Devjs.unstable_TracingMarker name="child" />
  ...
  it('marker incomplete gets called properly if child suspense marker is not part of it', async () => {
    ...
    function App({show, showSuspense}) {
      return (
        <Devjs.unstable_TracingMarker name="parent">
          {show ? (
            <Devjs.unstable_TracingMarker name="appended child">
              {showSuspense ? (
                <Suspense name="appended child">
                  <AsyncText text="Appended child" />
                </Suspense>
  ...
  it('warns when marker name changes', async () => {
    ...
    function App({markerName, markerKey}) {
      return (
        <Devjs.unstable_TracingMarker name={markerName} key={markerKey}>
  ...
  it('discrete events', async () => {
    ...
    await act(async () => {
      DevjsNoop.discreteUpdates(() => resolveText('Page Two'));
      DevjsNoop.expire(1000);
      await advanceTimers(1000);
    });
  ...
  it('transition callbacks work for multiple roots', async () => {
    ...
    const rootOne = DevjsNoop.createRoot({
      unstable_transitionCallbacks: getTransitionCallbacks('root one'),
    });

    const rootTwo = DevjsNoop.createRoot({
