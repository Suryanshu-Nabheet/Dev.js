...
describe('DevjsPersistent', () => {
  ...
  function createPortal(children, containerInfo, implementation, key) {
    return {
      $$typeof: Symbol.for('devjs.portal'),
  ...
  function render(element) {
    DevjsNoopPersistent.render(element);
  }
  ...
  function dangerouslyGetChildren() {
    return DevjsNoopPersistent.dangerouslyGetChildren();
  }
  ...
  it('supports portals', async () => {
    ...
    class BailoutTest extends Devjs.Component {
  ...
  it('remove children', async () => {
    ...
    const root = DevjsNoopPersistent.createRoot();
    await act(() => {
      root.render(
        <Wrapper>
          <inner />
