...
describe('DevjsSuspenseyCommitPhase', () => {
  beforeEach(() => {
    jest.resetModules();
    ...
    resolveSuspenseyThing = DevjsNoop.resolveSuspenseyThing;
    getSuspenseyThingStatus = DevjsNoop.getSuspenseyThingStatus;
  ...
  it('avoid triggering a fallback if resource loads immediately', async () => {
    ...
    await act(async () => {
      ...
      // Devjs will yield right after the resource suspends.
