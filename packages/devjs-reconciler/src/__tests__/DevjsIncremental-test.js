...
describe('DevjsIncremental', () => {
  ...
  it('should render a simple component, in steps if needed', async () => {
    ...
    Devjs.startTransition(() => {
      DevjsNoop.render(<Foo />, () => Scheduler.log('callback'));
    });
    // Do one step of work.
    await waitFor(['Foo']);
  ...
  it('can cancel partially rendered work and restart', async () => {
    ...
    DevjsNoop.flushSync(() => DevjsNoop.render(null));

    Devjs.startTransition(() => {
      DevjsNoop.render(<Foo text="baz" />);
    });
  ...
  it('should call callbacks even if updates are aborted', async () => {
    ...
    // This will abort the previous work and restart
    DevjsNoop.flushSync(() => DevjsNoop.render(<Foo />));
    Devjs.startTransition(() => {
      inst.setState(
        () => {
  ...
  it.skip('can resume work in a bailed subtree within one pass', async () => {
    ...
    class Tester extends Devjs.Component {
    ...
    // Init
    DevjsNoop.render(<Foo text="foo" />);
    DevjsNoop.flushDeferredPri(52 + 5);
  ...
  it.skip('can resume mounting a class component', async () => {
    ...
    DevjsNoop.render(<Parent prop="foo" />);
    DevjsNoop.flushDeferredPri(20);
  ...
  it.skip('can reuse work done after being preempted', async () => {
    ...
    // Init
    DevjsNoop.render(<Foo text="foo" text2="foo" step={0} />);
    DevjsNoop.flushDeferredPri(55 + 25 + 5 + 5);
    ...
    // middle content.
    DevjsNoop.render(<Foo text="foo" text2="bar" step={0} />);
    await waitForAll([]);
    ...
    DevjsNoop.render(<Foo text="bar" text2="bar" step={1} />);
    DevjsNoop.flushDeferredPri(30 + 25 + 5);

    assertLog(['Foo', 'Bar']);

    // The middle content is now pending rendering...
    DevjsNoop.flushDeferredPri(30 + 5);
    ...
    DevjsNoop.render(<Foo text="foo" text2="bar" step={1} />);
    DevjsNoop.flushDeferredPri(30);
  ...
  it.skip('can reuse work that began but did not complete, after being preempted', async () => {
    ...
    class Sibling extends Devjs.Component {
      render() {
  ...
  it('can use updater form of setState', async () => {
    ...
    DevjsNoop.render(<Foo multiplier={2} />);
    await waitForAll([]);
    ...
    instance.setState(updater);
    DevjsNoop.render(<Foo multiplier={3} />);
    await waitForAll([]);
  ...
  it('should clear forceUpdate after update is flushed', async () => {
    ...
    class Foo extends Devjs.PureComponent {
      render() {
    ...
    const foo = Devjs.createRef(null);
    DevjsNoop.render(<Foo ref={foo} b={0} />);
  ...
  it.skip('calls componentWillMount twice if the initial render is aborted', async () => {
    class LifeCycle extends Devjs.Component {
    ...
    DevjsNoop.render(<App x={0} />);
    DevjsNoop.flushDeferredPri(30);

    assertLog(['App', 'componentWillMount:0-0']);

    DevjsNoop.render(<App x={1} />);
    await waitForAll([
      'App',
  ...
  it('does not call getDerivedStateFromProps if neither state nor props have changed', async () => {
    ...
    const child = Devjs.createRef(null);
    DevjsNoop.render(<Parent />);
  ...
  it.skip('does not call componentWillReceiveProps for state-only updates', async () => {
    ...
    class Wrap extends Devjs.Component {
      state = {y: 0};
      UNSAFE_componentWillMount() {
        instances.push(this);
      }
  ...
  it('can nest batchedUpdates', async () => {
    ...
    // DevjsNoop.flush() not needed because updates are synchronous
  ...
  it('merges and masks context', async () => {
    class Intl extends Devjs.Component {
    ...
    class Router extends Devjs.Component {
      static childContextTypes = {
    ...
    class ShowLocale extends Devjs.Component {
      static contextTypes = {
        locale: PropTypes.string,
      };
      render() {
    ...
    class ShowRoute extends Devjs.Component {
      static contextTypes = {
        route: PropTypes.string,
      };
      render() {
    ...
    class ShowNeither extends Devjs.Component {
      render() {
  ...
  it('does not leak own context into context provider', async () => {
    ...
    class Recurse extends Devjs.Component {
      static contextTypes = {
        n: PropTypes.number,
      };
      static childContextTypes = {
  ...
  it('reads context when setState is below the provider', async () => {
    ...
    class ShowLocaleClass extends Devjs.Component {
      static contextTypes = {
        locale: PropTypes.string,
      };
      render() {
    ...
    class IndirectionClass extends Devjs.Component {
      render() {
  ...
  it.skip('should reuse memoized work if pointers are updated before calling lifecycles', async () => {
    ...
    class FirstChild extends Devjs.Component {
      componentDidUpdate(prevProps, prevState) {
    ...
    DevjsNoop.render(<Root>B</Root>);
    DevjsNoop.flushDeferredPri(20 + 30 + 5);
  ...
  it('updates descendants with new context values', async () => {
    ...
    class TopContextProvider extends Devjs.Component {
      static childContextTypes = {
  ...
  it('updates descendants with multiple context-providing ancestors with new context values', async () => {
    ...
    class MiddleContextProvider extends Devjs.Component {
      static childContextTypes = {
  ...
  it('should not update descendants with new context values if shouldComponentUpdate returns false', async () => {
    ...
    class MiddleScu extends Devjs.Component {
      shouldComponentUpdate() {
        return false;
      }
      render = () => this.props.children;
  ...
  it('does not interrupt for update at same priority', async () => {
    ...
    DevjsNoop.render(<Parent step={2} />);
  ...
  it('does interrupt for update at higher priority', async () => {
    ...
    DevjsNoop.flushSync(() => DevjsNoop.render(<Parent step={2} />));
    ...
    async function triggerCodePathThatUsesFibersAsMapKeys() {
      ...
      assertConsoleErrorDev([
        ...
        'Legacy context API has been detected within a strict-mode tree.\n' +
          ...
          '\n' +
          'Learn more about this warning here: https://devjs.dev/link/legacy-context\n' +
          '    in Boundary (at **)',
      ]);
    }
