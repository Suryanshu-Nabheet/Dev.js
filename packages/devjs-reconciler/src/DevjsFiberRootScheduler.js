...
import {peekEntangledActionLane} from './DevjsFiberAsyncAction';
...
export function ensureRootIsScheduled(root: FiberRoot): void {
  ...
  if (
    ...
    DevjsSharedInternals.didScheduleLegacyUpdate = true;
  }
}
...
function scheduleTaskForRootDuringMicrotask(
  ...
  // This function also never performs Devjs work synchronously; it should
...
function scheduleCallback(
  ...
  if (__DEV__ && DevjsSharedInternals.actQueue !== null) {
    ...
    DevjsSharedInternals.actQueue.push(callback);
...
function scheduleImmediateRootScheduleTask() {
  if (__DEV__ && DevjsSharedInternals.actQueue !== null) {
    ...
    DevjsSharedInternals.actQueue.push(() => {
      processRootScheduleInMicrotask();
      return null;
    });
  }
  ...
  if (supportsMicrotasks) {
    scheduleMicrotask(() => {
      ...
      // https://github.com/Suryanshu-Nabheet/dev.js/issues/22459
