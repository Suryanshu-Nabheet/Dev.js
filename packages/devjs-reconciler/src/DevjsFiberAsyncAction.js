...
import {NoLane} from './DevjsFiberLane';
import {
...
import {clearEntangledAsyncTransitionTypes} from './DevjsFiberTransitionTypes';
  ...
  thenable.then(
    ...
    error => {
      ...
      for (let i = 0; i < listeners.length; i++) {
        ...
        // instead of `onReject`, because we know that Devjs is the only
