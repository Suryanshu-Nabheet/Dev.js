...
import {SuspenseComponent} from './DevjsWorkTags';
...
} from 'shared/DevjsPerformanceTrackProperties';
...
const reusableCascadingUpdateIssue = {
  name: 'Devjs: Cascading Update',
  severity: 'warning',
  description:
    'A cascading update is an update that is triggered during an ongoing render. This can lead to performance issues.',
  learnMoreUrl:
    'https://devjs.dev/reference/dev-tools/devjs-performance-tracks#cascading-updates',
};

const DEEP_EQUALITY_WARNING =
  'This component received deeply equal props. It might benefit from useMemo or the Devjs Compiler in its owner.';
