...
import {LegacyRoot} from './DevjsRootTags';
import {
  findCurrentHostFiber,
  findCurrentHostFiberWithNoPortals,
} from './DevjsFiberTreeReflection';
import {get as getInstance} from 'shared/DevjsInstanceMap';
import {
  HostComponent,
  HostSingleton,
  ClassComponent,
...
import {createFiberRoot} from './DevjsFiberRoot';
...
import {
  isRendering as DevjsCurrentFiberIsRendering,
  current as DevjsCurrentFiberCurrent,
  runWithFiberInDEV,
} from './DevjsCurrentFiber';
import {StrictLegacyMode} from './DevjsTypeOfMode';
import {
  SyncLane,
...
export {createPortal} from './DevjsPortal';
export {
  ...
  focusWithin,
  observeVisibleRects,
} from './DevjsTestSelectors';
export {startHostTransition} from './DevjsFiberHooks';
export {
  defaultOnUncaughtError,
  defaultOnCaughtError,
  defaultOnRecoverableError,
} from './DevjsFiberErrorLogger';
import {getLabelForLane, TotalLanes} from 'devjs-reconciler/src/DevjsFiberLane';
import {registerDefaultIndicator} from './DevjsFiberAsyncAction';
...
function findHostInstance(component: Object): PublicInstance | null {
  ...
  if (fiber === undefined) {
    if (typeof component.render === 'function') {
      ...
      throw new Error(
        `Argument appears to not be a DevjsComponent. Keys: ${keys}`,
      );
    }
  }
...
function updateContainerImpl(
  ...
  if (__DEV__) {
    if (
      DevjsCurrentFiberIsRendering &&
      DevjsCurrentFiberCurrent !== null &&
      ...
      console.error(
        ...
        getComponentNameFromFiber(DevjsCurrentFiberCurrent) || 'Unknown',
      );
    }
  }
...
if (__DEV__) {
  ...
  overrideHookState = (
    ...
    if (hook !== null) {
      ...
      // As a result though, Devjs will see the scheduled update as a noop and bailout.
...
function getCurrentFiberForDevTools() {
  return DevjsCurrentFiberCurrent;
}
