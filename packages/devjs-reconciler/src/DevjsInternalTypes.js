...
import type {Lane, Lanes, LaneMap} from './DevjsFiberLane';
...
import type {ConcurrentUpdate} from './DevjsFiberConcurrentUpdates';
import type {ComponentStackNode} from 'devjs-server/src/DevjsFizzComponentStack';
import type {ThenableState} from './DevjsFiberThenable';
import type {ScheduledGesture} from './DevjsFiberGestureScheduler';

// Unwind Circular: moved from DevjsFiberHooks.old
...
export type Fiber = {
  ...
  _debugInfo?: DevjsDebugInfo | null,
  _debugOwner?: DevjsComponentInfo | Fiber | null,
...
export type AsyncDispatcher = {
  ...
  // DEV-only
  getOwner: () => null | Fiber | DevjsComponentInfo | ComponentStackNode,
};
