...
import type {Instance} from './DevjsFiberConfig';
...
export function observeVisibleRects(
  ...
  // When Devjs mutates the host environment, we may need to change what we're listening to.
  const commitHook = () => {
  ...
  return {
    disconnect: () => {
      // Stop listening for Devjs mutations:
