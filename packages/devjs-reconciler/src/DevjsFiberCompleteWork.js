...
import type {DevjsScopeInstance, DevjsContext} from 'shared/DevjsTypes';
import type {
  Instance,
  Type,
  Props,
...
function completeWork(
  ...
  switch (workInProgress.tag) {
        ...
        if (wasHydrated) {
          ...
          if (current !== null) {
            ...
            if (
              ...
              // next commit. This handles the case of Devjs rendering into a
    ...
    case ScopeComponent: {
      if (enableScopeAPI) {
        if (current === null) {
          const scopeInstance: DevjsScopeInstance = createScopeInstance();
