...
// Represents the nearest host transition provider (in Devjs DOM, a <form />)
// NOTE: Since forms cannot be nested, and this feature is only implemented by
// Devjs DOM, we don't technically need this to be a stack. It could be a single
