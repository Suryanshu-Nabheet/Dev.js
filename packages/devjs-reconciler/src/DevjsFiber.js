...
import type {RootTag} from './DevjsRootTags';
import type {WorkTag} from './DevjsWorkTags';
...
import {NoFlags, Placement, StaticMask} from './DevjsFiberFlags';
import {ConcurrentRoot} from './DevjsRootTags';
import {
  ClassComponent,
  HostRoot,
  HostComponent,
...
import {getComponentNameFromOwner} from 'devjs-reconciler/src/getComponentNameFromFiber';
import {isDevToolsPresent} from './DevjsFiberDevToolsHook';
import {
...
import {TransitionTracingMarker} from './DevjsFiberTracingMarkerComponent';
import {getHostContext} from './DevjsFiberHostContext';
...
function FiberNode(
  ...
  if (enableProfilerTimer) {
    ...
    // Unfortunately it makes Devjs unusably slow for some applications.
    // To work around this, initialize the fields below with doubles.
    //
    // Learn more about this here:
    // https://github.com/Suryanshu-Nabheet/dev.js/issues/14365
...
export function createFiberFromTypeAndProps(
  type: any, // Devjs$ElementType
  key: DevjsKey,
  pendingProps: any,
  owner: null | DevjsComponentInfo | Fiber,
  mode: TypeOfMode,
  lanes: Lanes,
): Fiber {
      ...
      default: {
        ...
        if (__DEV__) {
          ...
          if (type === null) {
            ...
            type !== undefined &&
            type.$$typeof === devjs_ELEMENT_TYPE
          ) {
            typeString = `<${
        ...
        // begin phase. This is the same thing we do in DevjsChildFiber if we throw
...
function createFiberFromProfiler(
  ...
  fiber.elementType = devjs_PROFILER_TYPE;
  fiber.lanes = lanes;
...
export function createFiberFromSuspense(
  ...
  fiber.elementType = devjs_SUSPENSE_TYPE;
  fiber.lanes = lanes;
  return fiber;
}
...
export function createFiberFromSuspenseList(
  ...
  fiber.elementType = devjs_SUSPENSE_LIST_TYPE;
  fiber.lanes = lanes;
  return fiber;
}
...
export function createFiberFromActivity(
  ...
  fiber.elementType = devjs_ACTIVITY_TYPE;
  fiber.lanes = lanes;
  return fiber;
}
...
export function createFiberFromViewTransition(
  ...
  fiber.elementType = devjs_VIEW_TRANSITION_TYPE;
  fiber.lanes = lanes;
...
export function createFiberFromLegacyHidden(
  ...
  fiber.elementType = devjs_LEGACY_HIDDEN_TYPE;
  fiber.lanes = lanes;
  return fiber;
}
...
export function createFiberFromTracingMarker(
  ...
  fiber.elementType = devjs_TRACING_MARKER_TYPE;
  fiber.lanes = lanes;
