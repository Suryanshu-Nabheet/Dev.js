...
if (__DEV__) {
  ...
  DevjsStrictModeWarnings.recordUnsafeLifecycleWarnings = (
    ...
    if (
      ...
      // Don't warn about devjs-lifecycles-compat polyfilled components.
    ...
    if (componentWillMountUniqueNames.size > 0) {
      ...
      console.warn(
        'componentWillMount has been renamed, and is not recommended for use. ' +
          ...
          'this warning in non-strict mode. In Devjs 18.x, only the UNSAFE_ name will work. ' +
          'To rename all deprecated lifecycles to their new names, you can run ' +
          '`npx devjs-codemod rename-unsafe-lifecycles` in your project source folder.\n' +
          '\nPlease update the following components: %s',
        sortedNames,
      );
    }
...
export default DevjsStrictModeWarnings;
