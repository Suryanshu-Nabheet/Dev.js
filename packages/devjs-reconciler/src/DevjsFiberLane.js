...
// Lane values below should be kept in sync with getLabelForLane(), used by devjs-devtools-timeline.
...
// This function is used for the experimental timeline (devjs-devtools-timeline)
...
function getHighestPriorityLanes(lanes: Lanes | Lane): Lanes {
  ...
  switch (getHighestPriorityLane(lanes)) {
    ...
    default:
      if (__DEV__) {
        console.error(
          'Should have found matching lanes. This is a bug in Devjs.',
        );
      }
...
export function markRootEntangled(root: FiberRoot, entangledLanes: Lanes) {
  ...
  // function and look at the tests that fail in DevjsTransition-test.js. Try
