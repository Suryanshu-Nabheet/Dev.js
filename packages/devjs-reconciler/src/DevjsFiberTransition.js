...
import {NoLane, type Lanes} from './DevjsFiberLane';
import type {StackCursor} from './DevjsFiberStack';
import type {Cache, SpawnedCachePool} from './DevjsFiberCacheComponent';
...
import {isPrimaryRenderer} from './DevjsFiberConfig';
...
} from './DevjsFiberTransitionTypes';
...
import {startAsyncTransitionTimer} from './DevjsProfilerTimer';
import {firstScheduledRoot} from './DevjsFiberRootScheduler';
import {
...
const prevOnStartTransitionFinish = DevjsSharedInternals.S;
DevjsSharedInternals.S = function onStartTransitionFinishForReconciler(
...
if (enableGestureTransition) {
  const prevOnStartGestureTransitionFinish = DevjsSharedInternals.G;
  DevjsSharedInternals.G = function onStartGestureTransitionFinishForReconciler(
    transition: Transition,
