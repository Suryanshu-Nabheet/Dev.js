...
import {isFiberSuspenseAndTimedOut} from './DevjsFiberTreeReflection';

import {HostComponent, ScopeComponent, ContextProvider} from './DevjsWorkTags';
...
export function createScopeInstance(): DevjsScopeInstance {
  return {
