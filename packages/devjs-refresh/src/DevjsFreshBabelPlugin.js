...
export default function (babel, opts = {}) {
      ...
      case 'CallExpression': {
        ...
        switch (calleePath.node.type) {
          ...
          case 'Identifier': {
            ...
            // const Foo = hoc1(hoc2(() => {}))
            // export default memo(Devjs.forwardRef(function() {}))
            callback(inferredName, node, path);
            return true;
          }
          default: {
        ...
        switch (init.type) {
          ...
          case 'CallExpression': {
            ...
            if (calleeType === 'Import') {
              ...
              // Could be something like Devjs.forwardRef(...)
              // Pass through.
            }
            break;
          }
  ...
  function isBuiltinHook(hookName) {
    switch (hookName) {
      ...
      case 'Devjs.useState':
      case 'useReducer':
      case 'Devjs.useReducer':
      case 'useEffect':
      case 'Devjs.useEffect':
      case 'useLayoutEffect':
      case 'Devjs.useLayoutEffect':
      case 'useMemo':
      case 'Devjs.useMemo':
      case 'useCallback':
      case 'Devjs.useCallback':
      case 'useRef':
      case 'Devjs.useRef':
      case 'useContext':
      case 'Devjs.useContext':
      case 'useImperativeHandle':
      case 'Devjs.useImperativeHandle':
      case 'useDebugValue':
      case 'Devjs.useDebugValue':
      case 'useId':
      case 'Devjs.useId':
      case 'useDeferredValue':
      case 'Devjs.useDeferredValue':
      case 'useTransition':
      case 'Devjs.useTransition':
      case 'useInsertionEffect':
      case 'Devjs.useInsertionEffect':
      case 'useSyncExternalStore':
      case 'Devjs.useSyncExternalStore':
      case 'useFormStatus':
      case 'Devjs.useFormStatus':
      case 'useFormState':
      case 'Devjs.useFormState':
      case 'useActionState':
      case 'Devjs.useActionState':
      case 'useOptimistic':
      case 'Devjs.useOptimistic':
        return true;
      default:
        return false;
    }
        ...
        findInnerComponents(
          ...
          (persistentID, targetExpr, targetPath) => {
            ...
            if (targetPath.parent.type === 'VariableDeclarator') {
              ...
              // we don't mess up the inferred 'Foo' function name.
              // (eg: with @babel/plugin-transform-devjs-display-name or
