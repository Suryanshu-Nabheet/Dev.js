...
describe('DevjsTestRendererTraversal', () => {
  beforeEach(() => {
    jest.resetModules();
    DevjsTestRenderer = require('devjs-test-renderer');
    act = require('internal-test-utils').act;
    Context = Devjs.createContext(null);
  });
      ...
      return (
        <View>
          <View foo="foo">
            ...
            <Devjs.Profiler id="test" onRender={() => {}}>
  ...
  class ExampleSpread extends Devjs.Component {
    render = () => <View {...this.props} />;
  }
  const ExampleFn = props => <View baz="baz" />;
  const ExampleNull = props => null;

  const ExampleForwardRef = Devjs.forwardRef((props, ref) => (
    <View {...props} ref={ref} />
  ));
  ...
  it('initializes', async () => {
    let render;
    await act(() => {
      render = DevjsTestRenderer.create(<Example />);
    });
  ...
  it('skips special nodes', async () => {
    ...
    expect(render.root.findAllByType(Devjs.Fragment)).toHaveLength(0);
  ...
  it('can have special nodes as roots', async () => {
    const FR = Devjs.forwardRef((props, ref) => <section {...props} />);

    let render1;
    await act(() => {
      render1 = DevjsTestRenderer.create(
        <FR>
          <div />
          <div />
        </FR>,
    ...
    let render2;
    await act(() => {
      render2 = DevjsTestRenderer.create(
        <>
          <div />
          <div />
        </>,
    ...
    let render3;
    await act(() => {
      render3 = DevjsTestRenderer.create(
    ...
    let render4;
    await act(() => {
      render4 = DevjsTestRenderer.create(
        <Devjs.StrictMode>
          <div />
          <div />
        </Devjs.StrictMode>,
    ...
    let render5;
    await act(() => {
      render5 = DevjsTestRenderer.create(
        <Context.Provider value={null}>
          <div />
          <div />
        </Context.Provider>,
