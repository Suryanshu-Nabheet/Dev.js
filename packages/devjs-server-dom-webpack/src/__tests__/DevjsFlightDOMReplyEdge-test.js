...
describe('DevjsFlightDOMReplyEdge', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('should be able to serialize any kind of typed array', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(buffers);
  ...
  it('should be able to serialize a blob', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(blob);
    const result = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
  ...
  it('should cancel the transported ReadableStream when we are cancelled', async () => {
    ...
    const result = await DevjsServerDOMServer.decodeReplyFromAsyncIterable(
      iterable,
      webpackServerMap,
    );
  ...
  it('should abort when parsing an incomplete payload', async () => {
    ...
    const promiseForResult = DevjsServerDOMClient.encodeReply(
  ...
  it('can stream the decoding using an async iterable', async () => {
    ...
    const formData = await DevjsServerDOMClient.encodeReply({
    ...
    const decoded = await DevjsServerDOMServer.decodeReplyFromAsyncIterable(
      iterable,
      webpackServerMap,
    );
