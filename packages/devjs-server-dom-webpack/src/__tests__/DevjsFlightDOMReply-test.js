...
describe('DevjsFlightDOMReply', () => {
  beforeEach(() => {
    ...
    jest.mock('devjs-server-dom-webpack/server', () =>
      require('devjs-server-dom-webpack/server.browser'),
    );
    const WebpackMock = require('./utils/WebpackMock');
    // serverExports = WebpackMock.serverExports;
    webpackServerMap = WebpackMock.webpackServerMap;
    Devjs = require('devjs');
    DevjsServerDOMServer = require('devjs-server-dom-webpack/server.browser');
    jest.resetModules();
    __unmockDevjs();
  ...
  it('can pass undefined as a reply', async () => {
    const body = await DevjsServerDOMClient.encodeReply(undefined);
    const missing = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
    expect(missing).toBe(undefined);

    const body2 = await DevjsServerDOMClient.encodeReply({
      array: [undefined, null, undefined],
      prop: undefined,
    });
    const object = await DevjsServerDOMServer.decodeReply(
      body2,
      webpackServerMap,
    );
  ...
  it('can pass an iterable as a reply', async () => {
    ...
    const iterable = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
    const items = [];
  ...
  it('can pass an iterator as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(iterator);
    const result = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
  ...
  it('can pass weird numbers as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(nums);
    const nums2 = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
  ...
  it('can pass a BigInt as a reply', async () => {
    const body = await DevjsServerDOMClient.encodeReply(90071992547409910000n);
    const n = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can pass FormData as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(formData);
    const formData2 = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
    );
  ...
  it('can pass two independent FormData with same keys', async () => {
    ...
    const {a: formDataA2, b: formDataB2} =
      await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can pass a Date as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(d);
    const d2 = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can pass a Map as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(m);
    const m2 = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can pass a Set as a reply', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply(s);
    const s2 = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('does not hang indefinitely when calling decodeReply with FormData', async () => {
    let error;
    try {
      await DevjsServerDOMServer.decodeReply(new FormData(), webpackServerMap);
    } catch (e) {
      error = e;
    }
  ...
  it('resolves a promise and includes its value', async () => {
    ...
    const bodyPromise = DevjsServerDOMClient.encodeReply({promise: promise});
    resolve('Hi');
    const result = await DevjsServerDOMServer.decodeReply(await bodyPromise);
    expect(await result.promise).toBe('Hi');
  });

  it('resolves a Devjs.lazy and includes its value', async () => {
    let resolve;
    const lazy = Devjs.lazy(() => new Promise(r => (resolve = r)));
    const bodyPromise = DevjsServerDOMClient.encodeReply({lazy: lazy});
    resolve({default: 'Hi'});
    const result = await DevjsServerDOMServer.decodeReply(await bodyPromise);
    expect(result.lazy).toBe('Hi');
  });

  it('resolves a proxy throwing a promise inside Devjs.lazy', async () => {
    let resolve1;
    let resolve2;
    const lazy = Devjs.lazy(() => new Promise(r => (resolve1 = r)));
    const promise = new Promise(r => (resolve2 = r));
    const bodyPromise1 = DevjsServerDOMClient.encodeReply({lazy: lazy});
    const target = {value: ''};
    let loaded = false;
    ...
    const bodyPromise2 = DevjsServerDOMClient.encodeReply({lazy: lazy});

    // Then resolve the inner thrown promise.
    loaded = true;
    await resolve2('Hello');

    const result1 = await DevjsServerDOMServer.decodeReply(await bodyPromise1);
    expect(await result1.lazy.value).toBe('Hello');
    const result2 = await DevjsServerDOMServer.decodeReply(await bodyPromise2);
  ...
  it('errors when called with JSX by default', async () => {
    let error;
    try {
      await DevjsServerDOMClient.encodeReply(<div />);
    } catch (x) {
      error = x;
    }
      ...
      expect.objectContaining({
        message: __DEV__
          ? expect.stringContaining(
              'Devjs Element cannot be passed to Server Functions from the Client without a temporary reference set.',
            )
          : expect.stringContaining(''),
      }),
    );
  ...
  it('can pass JSX through a round trip using temporary references', async () => {
    ...
    const temporaryReferences =
      DevjsServerDOMClient.createTemporaryReferenceSet();
    const body = await DevjsServerDOMClient.encodeReply(
      {children},
      {
        temporaryReferences,
    ...
    const temporaryReferencesServer =
      DevjsServerDOMServer.createTemporaryReferenceSet();
    const serverPayload = await DevjsServerDOMServer.decodeReply(
      body,
      webpackServerMap,
      {temporaryReferences: temporaryReferencesServer},
    );
    const stream = await serverAct(() =>
      DevjsServerDOMServer.renderToReadableStream(serverPayload, null, {
        temporaryReferences: temporaryReferencesServer,
      }),
    );
    const response = await DevjsServerDOMClient.createFromReadableStream(
      stream,
      {
        temporaryReferences,
      },
  ...
  it('can pass JSX as root model through a round trip using temporary references', async () => {
    ...
    const temporaryReferences =
      DevjsServerDOMClient.createTemporaryReferenceSet();
    const body = await DevjsServerDOMClient.encodeReply(jsx, {
      temporaryReferences,
    });
  ...
  it('can return the same object using temporary references', async () => {
    ...
    const temporaryReferences =
      DevjsServerDOMClient.createTemporaryReferenceSet();
    const body = await DevjsServerDOMClient.encodeReply(root, {
      temporaryReferences,
    });
  ...
  it('can return an opaque object through an async function', async () => {
    ...
    const temporaryReferences =
      DevjsServerDOMClient.createTemporaryReferenceSet();
    const body = await DevjsServerDOMClient.encodeReply(args, {
      temporaryReferences,
    });
  ...
  it('should supports streaming ReadableStream with objects', async () => {
    ...
    const promise = DevjsServerDOMClient.encodeReply({s1, s2});
  ...
  it('should supports streaming AsyncIterables with objects', async () => {
    ...
    // synchronously available using instrumented promises so that Devjs can
  ...
  it('can transport cyclic objects', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply({prop: cyclic});
    const root = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can transport cyclic arrays', async () => {
    ...
    const body = await DevjsServerDOMClient.encodeReply({prop: cyclic, obj});
    const root = await DevjsServerDOMServer.decodeReply(body, webpackServerMap);
  ...
  it('can abort an unresolved model and get the partial result', async () => {
    ...
    const bodyPromise = DevjsServerDOMClient.encodeReply(
    ...
    // has closed but that's a bug in both DevjsFlightReplyServer and DevjsFlightClient.
