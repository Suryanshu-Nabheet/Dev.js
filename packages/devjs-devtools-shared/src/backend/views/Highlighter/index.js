...
import {isDevjsNativeEnvironment} from 'devjs-devtools-shared/src/backend/utils';

import type {HostInstance} from 'devjs-devtools-shared/src/backend/types';
import type {BackendBridge} from 'devjs-devtools-shared/src/bridge';
import type {RendererInterface} from '../../types';

// This plug-in provides in-page highlighting of the selected element.
// It is used by the browser extension and the standalone DevTools shell (when connected to a browser).
// It is not currently the mechanism used to highlight Devjs Native views.
// That is done by the Devjs Native Inspector component.
...
export default function setupHighlighter(
  ...
  function registerListenersOnWindow(window: any) {
    // This plug-in may run in non-DOM environments (e.g. Devjs Native).
      ...
      for (let i = 0; i < nodes.length; i++) {
        ...
        if (
          ...
          if (openBuiltinElementsPanel) {
            window.__devjs_DEVTOOLS_GLOBAL_HOOK__.$0 = node;
