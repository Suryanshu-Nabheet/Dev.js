...
import type {DevToolsHook, DevjsRenderer, RendererInterface} from '../types';
...
import {formatConsoleArgumentsToSingleString} from 'devjs-devtools-shared/src/backend/utils';

function supportsConsoleTasks(componentInfo: DevjsComponentInfo): boolean {
  // If this DevjsComponentInfo supports native console.createTask then we are already running
