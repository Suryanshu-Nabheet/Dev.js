...
// This is a DevTools fork of DevjsComponentStackFrame.
// This fork enables DevTools to use the same "native" component stack format,
// while still maintaining support for multiple renderer versions
// (which use different values for DevjsTypeOfWork).
...
export function describeNativeComponentFrame(
  ...
  //
  // Note that unlike the code this was forked from (in DevjsComponentStackFrame)
  ...
  disableLogs();
  try {
    // NOTE: keep in sync with the implementation in DevjsComponentStackFrame
      ...
      DetermineComponentFrameRoot(): [?string, ?string] {
        ...
        try {
          ...
          if (construct) {
            ...
            // tries to access Devjs/DevjsDOM/props. We should probably make this throw
