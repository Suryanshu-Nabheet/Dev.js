...
import type {StyleAndLayout as StyleAndLayoutPayload} from 'devjs-devtools-shared/src/backend/NativeStyleEditor/types';
...
export type BridgeProtocol = {
  ...
  // NPM version range of `devjs-devtools-inline` that also supports this version.
...
export type BackendEvents = {
  ...
  // Devjs Native style editor plug-in.
  ...
  send<EventName: $Keys<OutgoingEvents>>(
    ...
    if (!this._scheduledFlush) {
      ...
      if (typeof devtoolsJestTestScheduler === 'function') {
        ...
        // because then we break Devjs DOM and we can't not mock it because then
