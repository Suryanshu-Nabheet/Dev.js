...
//
//    a. Search loaded source file to see if a custom Devjs metadata file is available.
...
import type {
  ...
  HookSource,
  HooksTree,
} from 'devjs-debug-tools/src/DevjsDebugHooks';
...
export type HookSourceAndMetadata = {
  // Generated by devjs-debug-tools.
  hookSource: HookSource,

  // Compiled code (Devjs components or custom hooks) containing primitive hook calls.
...
function initializeHookSourceAndMetadata(
  ...
  for (let i = 0; i < hooksList.length; i++) {
    ...
    if (hookSource == null) {
      // Older versions of devjs-debug-tools don't include this information.
