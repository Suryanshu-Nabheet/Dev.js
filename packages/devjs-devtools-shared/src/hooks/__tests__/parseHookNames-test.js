...
// Note that this test uses Devjs components declared in the "__source__" directory.
...
describe('parseHookNames', () => {
  ...
  beforeEach(() => {
    ...
    inspectHooks =
      require('devjs-debug-tools/src/DevjsDebugHooks').inspectHooks;
  ...
  describe('inline, external and bundle source maps', () => {
    ...
    // TODO Inline require (e.g. require("devjs").useState()) isn't supported yet.
  ...
  describe('extended source maps', () => {
    ...
    it('should work for simple components', async () => {
      ...
      ); // x_Suryanshu-Nabheet_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/fb-sources-extended/Example',
      ); // x_Suryanshu-Nabheet_sources extended external source map
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/Example',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/Example',
      ); // x_devjs_sources extended external source map

      // Using index map format for source maps
      await testFor(
        './__source__/__compiled__/inline/fb-sources-extended/index-map/Example',
      ); // x_Suryanshu-Nabheet_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/fb-sources-extended/index-map/Example',
      ); // x_Suryanshu-Nabheet_sources extended external index map source map
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/Example',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/Example',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work with more complex files and components', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ToDoList',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ToDoList',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ToDoList',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ToDoList',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work for custom hook', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ComponentWithCustomHook',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ComponentWithCustomHook',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ComponentWithCustomHook',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ComponentWithCustomHook',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work when code is using hooks indirectly', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ComponentUsingHooksIndirectly',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ComponentUsingHooksIndirectly',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ComponentUsingHooksIndirectly',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ComponentUsingHooksIndirectly',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work when code is using nested hooks', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ComponentWithNestedHooks',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ComponentWithNestedHooks',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ComponentWithNestedHooks',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ComponentWithNestedHooks',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work for external hooks', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ComponentWithExternalCustomHooks',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ComponentWithExternalCustomHooks',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ComponentWithExternalCustomHooks',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ComponentWithExternalCustomHooks',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should work when multiple hooks are on a line', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ComponentWithMultipleHooksPerLine',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ComponentWithMultipleHooksPerLine',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ComponentWithMultipleHooksPerLine',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ComponentWithMultipleHooksPerLine',
      ); // x_devjs_sources extended external index map source map
    ...
    it.skip('should work for inline requires', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/InlineRequire',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/InlineRequire',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/InlineRequire',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/InlineRequire',
      ); // x_devjs_sources extended external index map source map
    ...
    it('should support sources that contain the string "sourceMappingURL="', async () => {
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/ContainingStringSourceMappingURL',
      ); // x_devjs_sources extended inline source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/ContainingStringSourceMappingURL',
      ); // x_devjs_sources extended external source map
      ...
      await testFor(
        './__source__/__compiled__/inline/devjs-sources-extended/index-map/ContainingStringSourceMappingURL',
      ); // x_devjs_sources extended inline index map source map
      await testFor(
        './__source__/__compiled__/external/devjs-sources-extended/index-map/ContainingStringSourceMappingURL',
      ); // x_devjs_sources extended external index map source map
