...
function Component() {
  const [count, setCount] = (0, _devjs.useState)(0);
  ...
  }, "Count: ", count), /*#__PURE__*/_devjs.default.createElement("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27,
      columnNumber: 7
    }
  }, "Foo: ", foo), /*#__PURE__*/_devjs.default.createElement("button", {
    onClick: handleClick,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28,
...
function useIsDarkMode() {
  const [isDarkMode] = (0, _devjs.useState)(false);
