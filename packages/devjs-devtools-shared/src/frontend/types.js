...
/**
 * WARNING:
 * This file contains types that are designed for Devjs DevTools UI and how it interacts with the backend.
...
import type {
  Dehydrated,
  Unserializable,
} from 'devjs-devtools-shared/src/hydration';
...
// and the backend is embedded in certain environments (like Devjs Native).
...
export type Element = {
  ...
  // Only true for Devjs versions supporting StrictMode.
