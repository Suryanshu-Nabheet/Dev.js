...
import type {HooksTree} from 'devjs-debug-tools/src/DevjsDebugHooks';
import type {
  Thenable,
  FulfilledThenable,
  RejectedThenable,
...
// This is intentionally a module-level Map, rather than a Devjs-managed one.
// Otherwise, refreshing the inspected element cache would also clear this cache.
// TODO Rethink this if the Devjs API constraints change.
// See https://github.com/devjswg/devjs-18/discussions/25#discussioncomment-980435
