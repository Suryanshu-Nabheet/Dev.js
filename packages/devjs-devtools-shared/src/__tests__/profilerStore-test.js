...
describe('ProfilerStore', () => {
  ...
  it('should filter empty commits', () => {
    ...
    const ControlledInput = () => {
      const [name, setName] = Devjs.useState('foo');
  ...
  it('should filter empty commits alt', () => {
    ...
    const inputRef = Devjs.createRef();
    const Example = () => {
      const [, setTouched] = Devjs.useState(false);
  ...
  it('should throw if component filters are modified while profiling', () => {
    ...
    expect(() => {
      utils.act(() => {
        ...
        } = require('devjs-devtools-shared/src/frontend/types');
  ...
  it('should not throw if state contains a property hasOwnProperty', () => {
    ...
    const ControlledInput = () => {
      const [state, setState] = Devjs.useState({hasOwnProperty: true});
