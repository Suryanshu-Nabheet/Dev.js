...
describe('InspectedElementContext', () => {
  ...
  beforeEach(() => {
    ...
    backendAPI = require('devjs-devtools-shared/src/backendAPI');
  ...
  it('should inspect the currently selected element', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {a: 1, b: 'abc'}),
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {
          ...
          devjs_element: Devjs.createElement('span'),
          regexp: /abc/giu,
          set: setShallow,
  ...
  it('should support objects with no prototype', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {object}),
        document.createElement('div'),
      ),
    );
  ...
  it('should not consume iterables while inspecting', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {iteratable}),
        document.createElement('div'),
      ),
    );
  ...
  it('should support custom objects with enumerable properties and getters', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {data: new CustomData()}),
        document.createElement('div'),
      ),
    );
  ...
  it('should support objects with inherited keys', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {data: object}),
        document.createElement('div'),
      ),
    );
  ...
  it('should allow component prop value and value`s prototype has same name params.', async () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {data: testData}),
        document.createElement('div'),
      ),
    );
  ...
  it('should enable inspected values to be stored as global variables', () => {
    ...
    act(() =>
      DevjsDOM.render(
        Devjs.createElement(Example, {nestedObject}),
        document.createElement('div'),
      ),
    );
    ...
    jest.runOnlyPendingTimers();
    expect(logSpy).toHaveBeenCalledWith('$devjsTemp0');
    ...
    jest.runOnlyPendingTimers();
    expect(logSpy).toHaveBeenCalledWith('$devjsTemp1');
