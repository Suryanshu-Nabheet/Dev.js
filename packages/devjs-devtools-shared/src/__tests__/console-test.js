...
describe('console', () => {
  beforeEach(() => {
    const inject = global.__devjs_DEVTOOLS_GLOBAL_HOOK__.inject;
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.inject = internals => {
    ...
    Devjs = require('devjs');
    if (
      Devjs.version.startsWith('19') &&
      Devjs.version.includes('experimental')
    ) {
  ...
  it('should not append multiple stacks', () => {
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.appendComponentStack = true;
  ...
  it('should append component stacks to errors and warnings logged from effects', () => {
    ...
    const Child = ({children}) => {
      Devjs.useLayoutEffect(function Child_useLayoutEffect() {
        console.error('active error');
        console.log('active log');
        console.warn('active warn');
      });
      Devjs.useEffect(function Child_useEffect() {
  ...
  it('should append component stacks to errors and warnings logged from commit hooks', () => {
    ...
    class Child extends Devjs.Component<any> {
      componentDidMount() {
  ...
  it('should append component stacks to errors and warnings logged from gDSFP', () => {
    ...
    class Child extends Devjs.Component<any, any> {
      state = {};
  ...
  it('should correctly log Symbols', () => {
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.appendComponentStack = false;
  ...
  it('should double log if hideConsoleLogsInStrictMode is disabled in Strict mode', () => {
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.appendComponentStack = false;
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.hideConsoleLogsInStrictMode =
      false;
  ...
  it('should double log in Strict mode initial render for extension', () => {
    ...
    // This simulates a render that happens before Devjs DevTools have finished
    // their handshake to attach the Devjs DOM renderer functions to DevTools
    // In this case, we should still be able to mock the console in Strict mode
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.rendererInterfaces.delete(rendererID);
    const container = document.createElement('div');
    const root = DevjsDOMClient.createRoot(container);
  ...
  it('should not dim console logs if disableSecondConsoleLogDimmingInStrictMode is enabled', () => {
    ...
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.hideConsoleLogsInStrictMode =
      false;
    global.__devjs_DEVTOOLS_GLOBAL_HOOK__.settings.disableSecondConsoleLogDimmingInStrictMode =
      true;
