...
const enableComponentPerformanceTrack =
  Devjs.version.startsWith('19') && Devjs.version.includes('experimental');
  ...
  describe('User Timing API', () => {
    ...
    describe('with legacy render', () => {
      ...
      it('should mark sync render without suspends or state updates', () => {
        ...
        expect(registeredMarks).toMatchInlineSnapshot(`
          [
            "--devjs-internal-module-start-  at filtered (<anonymous>:0:0)",
            "--devjs-internal-module-stop-  at filtered (<anonymous>:1:1)",
            "--schedule-render-1",
            "--render-start-1",
            "--render-stop",
            "--commit-start-1",
            "--devjs-version-<filtered-version>",
            "--profiler-version-1",
            "--devjs-internal-module-start-  at filtered (<anonymous>:0:0)",
            "--devjs-internal-module-stop-  at filtered (<anonymous>:1:1)",
            "--devjs-lane-labels-Sync,InputContinuousHydration,InputContinuous,DefaultHydration,Default,TransitionHydration,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Transition,Retry,Retry,Retry,Retry,Retry,SelectiveHydration,IdleHydration,Idle,Offscreen",
      ...
      // TODO(hoxyq): investigate why running this test with Devjs 18 fails
      // @devjsVersion <= 18.2
      // @devjsVersion >= 18.0
    ...
    describe('with createRoot', () => {
      ...
      it('should mark render phase updates', async () => {
        function Example() {
          const [didRender, setDidRender] = Devjs.useState(false);
          if (!didRender) {
            setDidRender(true);
          }
          return didRender;
    ...
    describe('lane labels', () => {
      ...
      describe('with createRoot()', () => {
        ...
        it('regression test InputDiscreteLane', async () => {
          const targetRef = Devjs.createRef(null);
          ...
          // Wait a frame, for Devjs to process the "click" update.
    ...
    describe('when profiling', () => {
      ...
      describe('with createRoot()', () => {
        ...
        it('should mark concurrent render without suspends with state updates', () => {
          ...
          function Example() {
            const setHigh = Devjs.useState(0)[1];
            const setLow = Devjs.useState(0)[1];
        ...
        it('should mark render yields', async () => {
          ...
          // Finish flushing so Devjs commits;
        ...
        it('should generate component stacks for state update', async () => {
          ...
          function Child({initialRender}) {
            const [didRender, setDidRender] = Devjs.useState(initialRender);
            if (!didRender) {
              setDidRender(true);
            }
