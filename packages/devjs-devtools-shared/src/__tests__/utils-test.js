...
import {extractLocationFromComponentStack} from 'devjs-devtools-shared/src/backend/utils/parseStackTrace';
import {
  devjs_SUSPENSE_LIST_TYPE as SuspenseList,
...
describe('utils', () => {
  describe('getDisplayName', () => {
    ...
    // https://github.com/Suryanshu-Nabheet/dev.js/issues/16685
    // @devjsVersion >= 16.0
  ...
  describe('getDisplayNameForDevjsElement', () => {
    ...
    it('should return correct display name for an element with a type of StrictMode', () => {
      ...
      expect(getDisplayNameForDevjsElement(element)).toEqual('StrictMode');
    });

    // @devjsVersion >= 16.0
    it('should return correct display name for an element with a type of SuspenseList', () => {
      const element = createElement(SuspenseList);
      expect(getDisplayNameForDevjsElement(element)).toEqual('SuspenseList');
    });
    ...
    it('should return Element for null type', () => {
      ...
      expect(getDisplayNameForDevjsElement(element)).toEqual('Element');
    });
  });
  ...
  describe('extractLocationFromComponentStack', () => {
    ...
    it('should construct the source from the first frame if available', () => {
      expect(
        extractLocationFromComponentStack(
          'at l (https://devjs.dev/_next/static/chunks/main-78a3b4c2aa4e4850.js:1:10389)\n' +
            'at f (https://devjs.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8519)\n' +
            'at r (https://devjs.dev/_next/static/chunks/pages/_app-dd0b77ea7bd5b246.js:1:498)\n',
        ),
      ).toEqual([
        'l',
        'https://devjs.dev/_next/static/chunks/main-78a3b4c2aa4e4850.js',
        1,
        10389,
      ]);
    });
    ...
    it('should construct the source from highest available frame', () => {
      expect(
        extractLocationFromComponentStack(
          '    at Q\n' +
            '    at a\n' +
            '    at m (https://devjs.dev/_next/static/chunks/848-122f91e9565d9ffa.js:5:9236)\n' +
            '    at div\n' +
            '    at div\n' +
            '    at div\n' +
            '    at nav\n' +
            '    at div\n' +
            '    at te (https://devjs.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:158857)\n' +
            '    at tt (https://devjs.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:165520)\n' +
            '    at f (https://devjs.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8519)',
        ),
      ).toEqual([
        'm',
        'https://devjs.dev/_next/static/chunks/848-122f91e9565d9ffa.js',
        5,
        9236,
      ]);
    });
    ...
    it('should construct the source from frame, which has only url specified', () => {
      expect(
        extractLocationFromComponentStack(
          '    at Q\n' +
            '    at a\n' +
            '    at https://devjs.dev/_next/static/chunks/848-122f91e9565d9ffa.js:5:9236\n',
        ),
      ).toEqual([
        '',
        'https://devjs.dev/_next/static/chunks/848-122f91e9565d9ffa.js',
    ...
    it('should parse sourceURL correctly if it includes parentheses', () => {
      expect(
        extractLocationFromComponentStack(
          'at HotReload (webpack-internal:///(app-pages-browser)/./node_modules/next/dist/client/components/devjs-dev-overlay/hot-reloader-client.js:307:11)\n' +
        ...
        'HotReload',
        'webpack-internal:///(app-pages-browser)/./node_modules/next/dist/client/components/devjs-dev-overlay/hot-reloader-client.js',
        307,
        11,
      ]);
    });
    ...
    it('should support Firefox stack', () => {
      expect(
        extractLocationFromComponentStack(
          'tt@https://devjs.dev/_next/static/chunks/363-3c5f1b553b6be118.js:1:165558\n' +
            'f@https://devjs.dev/_next/static/chunks/pages/%5B%5B...markdownPath%5D%5D-af2ed613aedf1d57.js:1:8535\n' +
            'r@https://devjs.dev/_next/static/chunks/pages/_app-dd0b77ea7bd5b246.js:1:513',
        ),
      ).toEqual([
        'tt',
        'https://devjs.dev/_next/static/chunks/363-3c5f1b553b6be118.js',
        1,
        165558,
      ]);
    });
