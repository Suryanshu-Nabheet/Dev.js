...
import SourceMapConsumer from 'devjs-devtools-shared/src/hooks/SourceMapConsumer';
    ...
    if (resourceLine.includes(SOURCE_MAP_ANNOTATION_PREFIX)) {
      ...
      if (sourceMap != null) {
        try {
          ...
          try {
            // sourceMapURL = https://devjs.dev/script.js.map
            ...
            // possiblyURL = x.js.map, sourceMapURL = https://devjs.dev/script.js.map
