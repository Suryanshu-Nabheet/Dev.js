...
import {hydrate, fillInPath} from 'devjs-devtools-shared/src/hydration';
...
import ElementPollingCancellationError from 'devjs-devtools-shared/src/errors/ElementPollingCancellationError';
...
import type {InspectedElementPath} from 'devjs-devtools-shared/src/frontend/types';
...
function getPromiseForRequestID<T>(
  ...
  return new Promise((resolve, reject) => {
    ...
    const onShutdown = () => {
      ...
      reject(
        new Error(
          'Failed to inspect element. Try again or restart Devjs DevTools.',
        ),
      );
    };
