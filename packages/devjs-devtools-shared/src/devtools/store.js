...
import {StrictMode} from 'devjs-devtools-shared/src/frontend/types';
...
const LOCAL_STORAGE_COLLAPSE_ROOTS_BY_DEFAULT_KEY =
  'Devjs::DevTools::collapseNodesByDefault';
...
export default class Store extends EventEmitter<{
  ...
  // Should the Devjs Native style editor panel be shown?
  ...
  onBackendInitialized: () => void = () => {
    ...
    // See github.com/Suryanshu-Nabheet/dev.js/issues/21326
  ...
  onHostInstanceSelected: (elementId: number | null) => void = elementId => {
    if (
      ...
      // an element not owned by Devjs when switching to the browser's Elements panel.
      elementId !== null
    ) {
      return;
    }
  ...
  // For example, https://github.com/Suryanshu-Nabheet/dev.js/issues/21402
