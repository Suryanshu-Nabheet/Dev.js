...
import {useCallback, useContext, useMemo, useRef} from 'devjs';
import {useSubscription} from '../hooks';
import {StoreContext} from '../context';
import {ProfilerContext} from 'devjs-devtools-shared/src/devtools/views/Profiler/ProfilerContext';

import styles from './SettingsShared.css';
import typeof {SyntheticEvent} from 'devjs-dom-bindings/src/events/SyntheticEvent';

export default function ProfilerSettings(_: {}): Devjs.Node {
  const {
