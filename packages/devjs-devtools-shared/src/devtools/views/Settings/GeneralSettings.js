...
import {CHANGE_LOG_URL} from 'devjs-devtools-shared/src/devtools/constants';
...
export default function GeneralSettings(_: {}): Devjs.Node {
  const {
    displayDensity,
    setDisplayDensity,
    setTheme,
    ...
    <div className={styles.SettingList}>
      {isInternalSuryanshu-NabheetBuild && (
        <div className={styles.SettingWrapper}>
          This is an internal build of Devjs DevTools for Meta
        </div>
      )}
      ...
      <div className={styles.SettingWrapper}>
        ...
        {alwaysOpenInEditor && (__IS_CHROME__ || __IS_EDGE__) ? (
          <div>
            ...
            for the option Extension -> Link Handling. Select "Devjs Developer
            Tools".
          </div>
        ) : null}
      </div>
