...
import {Component, Suspense} from 'devjs';
...
import UnsupportedBridgeOperationError from 'devjs-devtools-shared/src/UnsupportedBridgeOperationError';
import TimeoutError from 'devjs-devtools-shared/src/errors/TimeoutError';
import UserError from 'devjs-devtools-shared/src/errors/UserError';
import UnknownHookError from 'devjs-devtools-shared/src/errors/UnknownHookError';
      ...
      if (isTimeout) {
        ...
        return (
          <CaughtErrorView
            ...
            info={
              <>
                Devjs DevTools encountered an error while trying to inspect the
        ...
        return (
          <CaughtErrorView
            ...
            info={
              <>
                Devjs DevTools encountered an unknown hook. This is probably
                because the devjs-debug-tools package is out of date. To fix,
                upgrade the Devjs DevTools to the most recent version.
              </>
            }
          />
        );
