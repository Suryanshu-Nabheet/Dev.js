...
import {useCallback, useEffect, useLayoutEffect, useMemo, useRef} from 'devjs';
...
import HookNamesModuleLoaderContext from 'devjs-devtools-shared/src/devtools/views/Components/HookNamesModuleLoaderContext';
import {ProfilerContextController} from './Profiler/ProfilerContext';
import {SuspenseTreeContextController} from './SuspenseTab/SuspenseTreeContext';
import {TimelineContextController} from 'devjs-devtools-timeline/src/TimelineContext';
import {ModalDialogContextController} from './ModalDialog';
import DevjsLogo from './DevjsLogo';
...
import type {HookNamesModuleLoaderFunction} from 'devjs-devtools-shared/src/devtools/views/Components/HookNamesModuleLoaderContext';
import type {FrontendBridge} from 'devjs-devtools-shared/src/bridge';
import type {BrowserTheme} from 'devjs-devtools-shared/src/frontend/types';
import type {DevjsFunctionLocation, DevjsCallSite} from 'shared/DevjsTypes';
import type {SourceSelection} from './Editor/EditorPane';

export type TabID = 'components' | 'profiler' | 'suspense';

export type ViewElementSource = (
  source: DevjsFunctionLocation | DevjsCallSite,
  symbolicatedSource: DevjsFunctionLocation | DevjsCallSite | null,
) => void;
...
const componentsTab = {
  ...
  icon: 'components',
  label: 'Components',
  title: 'Devjs Components',
};
const profilerTab = {
  id: ('profiler': TabID),
  icon: 'profiler',
  label: 'Profiler',
  title: 'Devjs Profiler',
};
const suspenseTab = {
  id: ('suspense': TabID),
  icon: 'suspense',
  label: 'Suspense',
  title: 'Devjs Suspense',
};
