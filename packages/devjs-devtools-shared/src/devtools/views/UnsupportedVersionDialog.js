...
import {Fragment, useContext, useEffect, useState} from 'devjs';
  ...
  return (
    <Fragment>
      <div className={styles.Row}>
        <div>
          <div className={styles.Title}>Unsupported Devjs version detected</div>
          <p>
            This version of Devjs DevTools supports Devjs DOM v15+ and Devjs
            Native v61+.
          </p>
          <p>
            In order to use DevTools with an older version of Devjs, you'll need
            to{' '}
            <a
