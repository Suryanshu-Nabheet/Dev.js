...
const SuspenseTreeStateContext: DevjsContext<SuspenseTreeState> =
  createContext<SuspenseTreeState>(((null: any): SuspenseTreeState));
SuspenseTreeStateContext.displayName = 'SuspenseTreeStateContext';

const SuspenseTreeDispatcherContext: DevjsContext<SuspenseTreeDispatch> =
...
function SuspenseTreeContextController({children}: Props): Devjs.Node {
