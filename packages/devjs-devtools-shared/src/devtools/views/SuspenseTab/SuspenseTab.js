...
import {enableActivitySlices} from 'devjs-devtools-feature-flags';
import {
  localStorageGetItem,
  localStorageSetItem,
...
import typeof {SyntheticPointerEvent} from 'devjs-dom-bindings/src/events/SyntheticEvent';
      ...
      <div className={styles.SuspenseTab} ref={wrapperTreeRef}>
        ...
        <div
          ...
          <InspectedElementErrorBoundary>
            <InspectedElement
              fallbackEmpty={
                'No Devjs element selected. Select a Suspense boundary in the minimap to inspect.'
              }
            />
          </InspectedElementErrorBoundary>
        </div>
...
const LOCAL_STORAGE_KEY = 'Devjs::DevTools::SuspenseTab::layout';
