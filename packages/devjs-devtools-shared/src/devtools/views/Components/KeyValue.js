...
import {useTransition, useContext, useRef, useState, useMemo} from 'devjs';
...
import type {Element as DevjsElement} from 'devjs';
...
export default function KeyValue({
  ...
  if (isSimpleType) {
    ...
    if (isArray(value)) {
      ...
      children = entries.map(([key, keyValue]): DevjsElement<any> => (
        <KeyValue
          key={key}
          alphaSort={alphaSort}
          bridge={bridge}
