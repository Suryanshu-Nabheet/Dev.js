...
import {useContext, useMemo, useRef, useState} from 'devjs';
...
export default function StyleEditor({id, style}: Props): Devjs.Node {
...
function Row({
  ...
  // which would need to require them from DevjsNativeViewViewConfig "validAttributes.style" keys.
  // This would need to degrade gracefully for devjs-native-web,
