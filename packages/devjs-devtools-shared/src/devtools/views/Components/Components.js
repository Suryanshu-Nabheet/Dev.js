...
import {Fragment, useEffect, useLayoutEffect, useReducer, useRef} from 'devjs';
            ...
            <div className={styles.InspectedElementWrapper}>
              <NativeStyleContextController>
                <InspectedElementErrorBoundary>
                  <InspectedElement
                    fallbackEmpty={
                      'No Devjs element selected. Select an element in the tree to inspect.'
                    }
                  />
                </InspectedElementErrorBoundary>
              </NativeStyleContextController>
...
const LOCAL_STORAGE_KEY = 'Devjs::DevTools::createResizeReducer';
