...
import {Fragment, startTransition, useContext, useMemo, useState} from 'devjs';
...
import type {Element as ElementType} from 'devjs-devtools-shared/src/frontend/types';
...
export default function Element({data, index, style}: Props): Devjs.Node {
