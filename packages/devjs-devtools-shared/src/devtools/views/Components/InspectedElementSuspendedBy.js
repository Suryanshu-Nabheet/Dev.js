...
import {useState, useTransition} from 'devjs';
  ...
  return (
    <div className={styles.CollapsableRow}>
      <Button
        ...
        // TODO: May be better to leave to Devjs's default Transition indicator.
...
export default function InspectedElementSuspendedBy({
  ...
  if (
    ...
    // these elements.
    // This can happen for older versions of Devjs without Suspense, older versions
    // of Devjs with less sources for Suspense, or simple UIs that don't have any suspenders.
    ...
    case UNKNOWN_SUSPENDERS_REASON_PRODUCTION:
      unknownSuspenders = (
        <div className={styles.InfoRow}>
          ...
          builds of Devjs. Test this in development mode to see exactly what
          might suspend.
        </div>
      );
      break;
    case UNKNOWN_SUSPENDERS_REASON_OLD_VERSION:
      unknownSuspenders = (
        <div className={styles.InfoRow}>
          ...
          in older versions of Devjs. Upgrade to the latest version of Devjs to
