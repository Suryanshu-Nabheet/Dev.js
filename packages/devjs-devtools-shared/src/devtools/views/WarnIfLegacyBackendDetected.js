      ...
      switch (message.type) {
        ...
        case 'many-events':
          ...
          dispatch({
            ...
            type: 'SHOW',
            title: 'DevTools v4 is incompatible with this version of Devjs',
...
function InvalidBackendDetected(_: {}) {
  return (
    <Fragment>
      <p>Either upgrade Devjs or install Devjs DevTools v3:</p>
      <code className={styles.Command}>npm install -d devjs-devtools@^3</code>
    </Fragment>
  );
}
