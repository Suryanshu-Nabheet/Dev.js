...
import {useCallback, useContext, useSyncExternalStore} from 'devjs';
...
const useOpenResource = (
  source: null | DevjsFunctionLocation | DevjsCallSite,
  symbolicatedSource: null | DevjsFunctionLocation | DevjsCallSite,
): [
  boolean, // isEnabled
  () => void, // Open Resource
] => {
