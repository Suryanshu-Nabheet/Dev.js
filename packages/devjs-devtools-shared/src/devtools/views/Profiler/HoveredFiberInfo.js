...
import {Fragment, useContext} from 'devjs';
...
export default function HoveredFiberInfo({fiberData}: Props): Devjs.Node {
        ...
        {node != null && (
          <div className={styles.BadgesContainer}>
            ...
            {node.compiledWithForget && (
              <div>
                ✨ This component has been auto-memoized by the Devjs Compiler.
              </div>
            )}
          </div>
        )}
