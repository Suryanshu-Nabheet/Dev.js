...
import {Fragment, useContext, useCallback, useRef} from 'devjs';
...
export default function ProfilingImportExportButtons(): Devjs.Node {
    ...
    if (input !== null && input.files.length > 0) {
      ...
      fileReader.addEventListener('load', () => {
        ...
        if (!isArray(json) && hasOwnProperty.call(json, 'version')) {
          // This looks like Devjs profiling data.
          ...
          // But first, clear Devjs profiling data; we should only have one type open at a time.
          profilerStore.clear();
