...
import {Fragment, memo, useCallback, useContext} from 'devjs';
import {areEqual} from 'devjs-window';
...
function CommitFlamegraphListItem({data, index, style}: Props): Devjs.Node {
  const {
    chartData,
    onElementMouseEnter,
    onElementMouseLeave,
