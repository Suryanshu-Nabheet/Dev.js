...
import {PROFILER_EXPORT_VERSION} from 'devjs-devtools-shared/src/constants';
import {backendToFrontendSerializedElementMapper} from 'devjs-devtools-shared/src/utils';

import type {ProfilingDataBackend} from 'devjs-devtools-shared/src/backend/types';
import type {
  ProfilingDataExport,
  ...
  dataBackends.forEach(dataBackend => {
    ...
    if (timelineData != null) {
      const {
        ...
        laneToDevjsMeasureKeyValueArray,
        ...rest
      } = timelineData;
      ...
      timelineDataArray.push({
        ...
        laneToDevjsMeasureMap: new Map(laneToDevjsMeasureKeyValueArray),
      });
    }
