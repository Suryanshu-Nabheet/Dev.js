const chromeManifest = require('../devjs-devtools-extensions/chrome/manifest.json');
const firefoxManifest = require('../devjs-devtools-extensions/firefox/manifest.json');
...
module.exports = api => {
  ...
  if (process.env.NODE_ENV !== 'production') {
    plugins.push(['@babel/plugin-transform-devjs-jsx-source']);
  }
  return {
    plugins,
    presets: [
