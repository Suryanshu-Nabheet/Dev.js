  ...
  if (__DEV__) {
    if (typeof format === 'string') {
      ...
      if (
        ...
        // This looks like an error with addendum from DevjsFiberErrorLogger.
        // They are noisy too so we'll try to ignore them.
        return true;
      }
      if (
        format.indexOf('DevjsDOM.render was removed in Devjs 19') !== -1 ||
        format.indexOf('DevjsDOM.hydrate was removed in Devjs 19') !== -1 ||
        format.indexOf(
        ...
        format.indexOf('devjs-test-renderer is deprecated.') !== -1
      ) {
    ...
    if (
      ...
      // In production, DevjsFiberErrorLogger logs error objects directly.
      // They are noisy too so we'll try to ignore them.
      return true;
    }
  }
