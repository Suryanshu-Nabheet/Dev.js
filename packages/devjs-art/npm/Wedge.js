...
/**
 * Wedge is a Devjs component for drawing circles, wedges and arcs. Like other
 * DevjsART components, it must be used in a <Surface>.
 */
var Wedge = createDevjsClass({
  displayName: 'Wedge',
   ...
   *
   * Creates the DevjsART Path for a complete circle.
   *
   ...
   *
   * Creates the DevjsART Path for an arc or wedge.
   *
