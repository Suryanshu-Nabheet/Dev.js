...
import DevjsNativeWeb from './DevjsNativeWeb';
...
ignoreErrors([
  ...
  'Warning: DevjsDOM.render was removed in Devjs 19',
  'Warning: devjs-test-renderer is deprecated',
  // Ignore prefixed and not prefixed since I don't know which
  // Devjs versions are being tested by this code.
  'Legacy context API',
  'Unsafe lifecycle methods',
  '%s is deprecated in StrictMode.', // findDOMNode
  'DevjsDOM.render was removed in Devjs 19',
...
function mountLegacyApp(App: () => Devjs$Node) {
  // $FlowFixMe[prop-missing]: These are removed in 19.
  const {render, unmountComponentAtNode} = require('devjs-dom');
...
const shouldRenderLegacy = semver.lte(
  process.env.E2E_APP_devjs_VERSION,
  '18.2.0',
);
