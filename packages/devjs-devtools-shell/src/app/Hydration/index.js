...
import {Fragment, useDebugValue, useState} from 'devjs';
...
export default function Hydration(): Devjs.Node {
  return (
    <Fragment>
      <h1>Hydration</h1>
      <DehydratableProps
...
function Use({value}: {value: Promise<mixed>}): Devjs.Node {
  Devjs.use(value);
  return null;
}

class IgnoreErrors extends Devjs.Component {
