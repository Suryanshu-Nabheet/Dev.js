...
const {useState, useEffect, useSyncExternalStore} = Devjs;
...
export default function UseSyncExternalStore(): Devjs.Node {
  return (
    <>
...
function SingleHookCase(): Devjs.Node {
...
function HookTreeCase(): Devjs.Node {
