...
import {useFormState, useFormStatus} from 'devjs-dom';
...
function FunctionWithHooks(props: any, ref: Devjs$RefSetter<any>) {
...
function wrapWithHoc(
  Component: (props: any, ref: Devjs$RefSetter<any>) => any,
) {
  function Hoc() {
    return <Component />;
  }
...
class ErrorBoundary extends Devjs.Component<{children?: Devjs$Node}> {
...
export default function CustomHooks(): Devjs.Node {
  return (
    <Fragment>
      <FunctionWithHooks />
      <MemoWithHooks />
