...
import {createContext, useMemo, useReducer} from 'devjs';
...
type State = {
  ...
  searchResults: Array<DevjsComponentMeasure>,
  searchText: string,
};
...
const EMPTY_ARRAY: Array<DevjsComponentMeasure> = [];
...
const TimelineSearchContext: DevjsContext<Context> = createContext<Context>(
  ((null: any): Context),
);
