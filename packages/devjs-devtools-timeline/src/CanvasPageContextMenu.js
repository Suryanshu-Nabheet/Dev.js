...
import ContextMenuContainer from 'devjs-devtools-shared/src/devtools/ContextMenu/ContextMenuContainer';
...
import type {
  ContextMenuItem,
  ContextMenuRef,
} from 'devjs-devtools-shared/src/devtools/ContextMenu/types';
import type {
  DevjsEventInfo,
  DevjsMeasure,
  TimelineData,
...
function copySummary(data: TimelineData, measure: DevjsMeasure) {
