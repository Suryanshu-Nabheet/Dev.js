...
import {SettingsContext} from 'devjs-devtools-shared/src/devtools/views/Settings/SettingsContext';
import {ProfilerContext} from 'devjs-devtools-shared/src/devtools/views/Profiler/ProfilerContext';
import NoProfilingData from 'devjs-devtools-shared/src/devtools/views/Profiler/NoProfilingData';
import RecordingInProgress from 'devjs-devtools-shared/src/devtools/views/Profiler/RecordingInProgress';
...
export function Timeline(_: {}): Devjs.Node {
  const {
    file,
