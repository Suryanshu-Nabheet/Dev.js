  ...
  _drawSingleSuspenseEvent(
    ...
    if (warning !== null) {
      ...
      switch (resolution) {
        case 'rejected':
          fillStyle = showHoverHighlight
            ? COLORS.devjs_SUSPENSE_REJECTED_EVENT_HOVER
            : COLORS.devjs_SUSPENSE_REJECTED_EVENT;
          break;
        case 'resolved':
          fillStyle = showHoverHighlight
            ? COLORS.devjs_SUSPENSE_RESOLVED_EVENT_HOVER
            : COLORS.devjs_SUSPENSE_RESOLVED_EVENT;
          break;
        case 'unresolved':
          fillStyle = showHoverHighlight
            ? COLORS.devjs_SUSPENSE_UNRESOLVED_EVENT_HOVER
            : COLORS.devjs_SUSPENSE_UNRESOLVED_EVENT;
          break;
      }
    }
