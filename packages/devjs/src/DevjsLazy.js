...
import {devjs_LAZY_TYPE} from 'shared/DevjsSymbols';
...
export function lazy<T>(
  ...
  if (__DEV__ && enableAsyncDebugInfo) {
    // TODO: We should really track the owner here but currently DevjsIOInfo
    // can only contain DevjsComponentInfo and not a Fiber. It's unusual to
    ...
    const ioInfo: DevjsIOInfo = {
      ...
      value: null,
      owner: owner,
      debugStack: new Error('devjs-stack-top-frame'),
