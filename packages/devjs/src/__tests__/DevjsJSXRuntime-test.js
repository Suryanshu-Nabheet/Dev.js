...
describe('DevjsJSXRuntime', () => {
  beforeEach(() => {
    jest.resetModules();

    Devjs = require('devjs');
    JSXRuntime = require('devjs/jsx-runtime');
    JSXDEVRuntime = require('devjs/jsx-dev-runtime');
  ...
  it('should warn when unkeyed children are passed to jsx', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique "key" prop.\n\n' +
        'Check the render method of `Parent`. See https://devjs.dev/link/warning-keys for more information.\n' +
        '    in Parent (at **)',
    ]);
  });
