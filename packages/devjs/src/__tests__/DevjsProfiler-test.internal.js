...
function loadModules({
  ...
  AdvanceTime = class extends Devjs.Component {
    static defaultProps = {
      byAmount: 10,
...
describe(`onRender`, () => {
  ...
  it('should handle errors thrown', async () => {
    ...
    await expect(
      act(() => {
        DevjsNoop.render(
          <ClassComponent>
            <Devjs.Profiler id="do-not-throw" onRender={callback}>
              <Devjs.Profiler id="throw" onRender={callback}>
                <div />
              </Devjs.Profiler>
            </Devjs.Profiler>
          </ClassComponent>,
  ...
  it('is not invoked until the commit phase', async () => {
    ...
    Devjs.startTransition(() => {
      DevjsNoop.render(
        <Devjs.Profiler id="test" onRender={callback}>
          <Yield value="first" />
          <Yield value="last" />
        </Devjs.Profiler>,
      );
  ...
  it('does not record times for components outside of Profiler tree', async () => {
    ...
    jest.mock('scheduler', obj => {
      const ActualScheduler = jest.requidevjsual('scheduler/unstable_mock');
      return {
        ...ActualScheduler,
  ...
  it('does not report work done on a sibling', async () => {
    ...
    const DoesNotUpdate = Devjs.memo(
    ...
    if (gate(flags => flags.enableUseJSStackToTrackPassiveDurations)) {
      ...
      // since Devjs technically did a little bit of work between the Profiler and the bailed out subtree.
  ...
  it('includes render times of nested Profilers in their parent times', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Fragment>
          <Devjs.Profiler id="parent" onRender={callback}>
            <AdvanceTime byAmount={10}>
              <Devjs.Profiler id="child" onRender={callback}>
  ...
  it('traces sibling Profilers separately', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Fragment>
          <Devjs.Profiler id="first" onRender={callback}>
            <AdvanceTime byAmount={20} />
          </Devjs.Profiler>
          <Devjs.Profiler id="second" onRender={callback}>
  ...
  it('is not called when blocked by sCU false', async () => {
    ...
    let instance;
    class Updater extends Devjs.Component {
      state = {};
      render() {
        instance = this;
        return this.props.children;
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="outer" onRender={callback}>
          <Updater>
            <Devjs.Profiler id="inner" onRender={callback}>
              <div />
            </Devjs.Profiler>
          </Updater>
        </Devjs.Profiler>,
    ...
    // Devjs does not re-render its children.
    expect(callback).toHaveBeenCalledTimes(1);
  ...
  it('includes time spent in render phase lifecycles', async () => {
    class WithLifecycles extends Devjs.Component {
      state = {};
  ...
  it('should clear nested-update flag when multiple cascading renders are scheduled', async () => {
    ...
    function Component() {
      ...
      const [didMountAndUpdate, setDidMountAndUpdate] = Devjs.useState(false);
    ...
    await act(() => {
      DevjsNoop.render(
        <Devjs.Profiler id="root" onRender={onRender}>
          <Component />
        </Devjs.Profiler>,
      );
    });
  ...
  describe('with regard to interruptions', () => {
    ...
    it('should report the expected times when a high-priority update interrupts a low-priority update', async () => {
      ...
      let first;
      class FirstComponent extends Devjs.Component {
        state = {renderTime: 1};
        render() {
          first = this;
      ...
      let second;
      class SecondComponent extends Devjs.Component {
        state = {renderTime: 2};
        render() {
          second = this;
          Scheduler.unstable_advanceTime(this.state.renderTime);
      ...
      DevjsNoop.flushSync(() => second.setState({renderTime: 30}));
    ...
    it('should reset the fiber stack correct after a "complete" phase error', async () => {
      ...
      // This mimics behavior like Devjs Native's View/Text nesting validation.
      DevjsNoop.render(
      ...
      // A similar case we've seen caused by an invariant in DevjsDOM.
  ...
  it('reflects the most recently rendered id value', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="one" onRender={callback}>
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="two" onRender={callback}>
...
describe(`onCommit`, () => {
  ...
  it('should report time spent in layout effects and commit lifecycles', async () => {
    ...
    class ComponentWithCommitHooks extends Devjs.Component {
      componentDidMount() {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="mount-test" onCommit={callback}>
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="update-test" onCommit={callback}>
          <ComponentWithEffects />
          <ComponentWithCommitHooks />
        </Devjs.Profiler>,
      );
    ...
    await act(() => {
      root.render(<Devjs.Profiler id="unmount-test" onCommit={callback} />);
    });
  ...
  it('should report time spent in layout effects and commit lifecycles with cascading renders', async () => {
    ...
    const ComponentWithEffects = ({shouldCascade}) => {
      const [didCascade, setDidCascade] = Devjs.useState(false);
  ...
  it('should include time spent in ref callbacks', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="root" onCommit={callback}>
          <Component />
        </Devjs.Profiler>,
      );
    });
    ...
    await act(() => {
      root.render(<Devjs.Profiler id="root" onCommit={callback} />);
    });
  ...
  it('should bubble time spent in layout effects to higher profilers', async () => {
    ...
    const ComponentWithEffects = ({cleanupDuration, duration, setCountRef}) => {
      const setCount = Devjs.useState(0)[1];
      if (setCountRef != null) {
    ...
    const setCountRef = Devjs.createRef(null);

    const root = DevjsNoop.createRoot();
    await act(() => {
      root.render(
        <Devjs.Profiler id="root-mount" onCommit={callback}>
          <Devjs.Profiler id="a">
            <ComponentWithEffects
              duration={10}
              cleanupDuration={100}
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="root-update" onCommit={callback}>
          <Devjs.Profiler id="b">
            <ComponentWithEffects duration={1000} cleanupDuration={10000} />
          </Devjs.Profiler>
        </Devjs.Profiler>,
...
describe(`onPostCommit`, () => {
  ...
  it('should report time spent in passive effects', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="mount-test" onPostCommit={callback}>
          <ComponentWithEffects />
        </Devjs.Profiler>,
      );
    });
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="update-test" onPostCommit={callback}>
          <ComponentWithEffects />
        </Devjs.Profiler>,
      );
    });
    ...
    await act(() => {
      root.render(<Devjs.Profiler id="unmount-test" onPostCommit={callback} />);
    });
    await waitForAll([]);
  ...
  it('should bubble time spent in effects to higher profilers', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="root-mount" onPostCommit={callback}>
          <Devjs.Profiler id="a">
            <ComponentWithEffects
              duration={10}
              cleanupDuration={100}
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="root-update" onPostCommit={callback}>
          <Devjs.Profiler id="b">
            <ComponentWithEffects duration={1000} cleanupDuration={10000} />
          </Devjs.Profiler>
        </Devjs.Profiler>,
  ...
  it('should properly report time in passive effects even when there are errors', async () => {
    ...
    await act(() => {
      root.render(
        <Devjs.Profiler id="root" onPostCommit={callback}>
          <ErrorBoundary
            fallback={
              <ComponentWithEffects
                duration={10000000}
