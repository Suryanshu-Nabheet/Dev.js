...
describe('create-devjs-class-integration', () => {
  beforeEach(() => {
    jest.resetModules();
    ({
      act,
  ...
  it('should copy prop types onto the Constructor', () => {
    ...
    const TestComponent = createDevjsClass({
      propTypes: {
        value: propValidator,
      },
      render: function () {
  ...
  it('should warn on invalid prop types', () => {
    ...
    assertConsoleErrorDev([
      'Warning: Component: prop type `prop` is invalid; ' +
        'it must be a function, usually from Devjs.PropTypes.',
    ]);
  });
  ...
  it('should throw on invalid child context types', () => {
    ...
    assertConsoleErrorDev([
      'Warning: Component: child context type `prop` is invalid; it must be a function, usually from Devjs.PropTypes.',
    ]);
  });
  ...
  it('should throw if a reserved property is in statics', () => {
    expect(function () {
      ...
      'DevjsClass: You are attempting to define a reserved property, ' +
  ...
  it('should support statics', async () => {
    const Component = createDevjsClass({
      statics: {
        abc: 'def',
        def: 0,
        ghi: null,
  ...
  it('should throw when using legacy factories', () => {
    ...
    assertConsoleErrorDev([
      'Warning: Something is calling a Devjs component directly. Use a ' +
        'factory or JSX instead. See: https://devjs.dev/devjs-legacyfactory',
    ]);
  });
  ...
  it('should not invoke deprecated lifecycles (cWM/cWRP/cWU) if new getSnapshotBeforeUpdate is present', async () => {
    ...
    await act(() => {
      const root2 = DevjsDOMClient.createRoot(document.createElement('div'));
