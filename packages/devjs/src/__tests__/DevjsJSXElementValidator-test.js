...
describe('DevjsJSXElementValidator', () => {
  let Component;
  ...
  beforeEach(() => {
    ...
    RequiredPropComponent = class extends Devjs.Component {
      render() {
  ...
  it('warns for keys for arrays of elements with owner info', async () => {
    ...
    assertConsoleErrorDev([
      'Each child in a list should have a unique "key" prop.' +
        ...
        'It was passed a child from ComponentWrapper. See https://devjs.dev/link/warning-keys for more information.\n' +
  ...
  it('should give context for errors in nested components.', async () => {
    class MyComp extends Devjs.Component {
      render() {
        return [<div />];
      }
    }
  ...
  it('warns for fragments with refs', async () => {
    ...
    assertConsoleErrorDev(
      gate('enableFragmentRefs')
        ? []
        : [
            'Invalid prop `ref` supplied to `Devjs.Fragment`.' +
