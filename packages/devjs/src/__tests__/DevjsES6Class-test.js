...
describe('DevjsES6Class', () => {
  ...
  beforeEach(() => {
    ...
    renderedName = null;
    Inner = class extends Devjs.Component {
      getName() {
  ...
  it('throws if no render function is defined', () => {
    ...
    try {
      DevjsDOM.flushSync(() => root.render(<Foo />));
      assertConsoleErrorDev([
  ...
  it('warns if getDerivedStateFromProps is not static', () => {
    ...
    DevjsDOM.flushSync(() => root.render(<Foo foo="foo" />));
    assertConsoleErrorDev([
  ...
  if (!require('shared/DevjsFeatureFlags').disableLegacyContext) {
  ...
  it('will call all the normal life cycle methods', () => {
    ...
    lifeCycles = []; // reset
    DevjsDOM.flushSync(() => root.unmount());
