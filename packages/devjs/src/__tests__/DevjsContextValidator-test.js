...
// in the core DevjsCompositeComponent. It should technically live in core's
...
describe('DevjsContextValidator', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('should filter out context not in contextTypes', async () => {
    ...
    class ComponentInFooBarContext extends Devjs.Component {
  ...
  it('should pass parent context if getChildContext method is missing', async () => {
    class ParentContextProvider extends Devjs.Component {
      static childContextTypes = {
        foo: PropTypes.string,
      };
      getChildContext() {
    ...
    class MiddleMissingContext extends Devjs.Component {
      static childContextTypes = {
        bar: PropTypes.string.isRequired,
      };
      render() {
    ...
    let childContext;
    class ChildContextConsumer extends Devjs.Component {
      render() {
