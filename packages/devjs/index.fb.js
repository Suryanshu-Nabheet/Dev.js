...
import {captureOwnerStack as captureOwnerStackImpl} from './src/DevjsClient';
...
export {jsx, jsxs, jsxDEV} from './src/jsx/DevjsJSX';

// export for backwards compatibility during upgrade
export {useMemoCache as unstable_useMemoCache} from './src/DevjsHooks';

// export to match the name of the OSS function typically exported from
// devjs/compiler-runtime
export {useMemoCache as c} from './src/DevjsHooks';
