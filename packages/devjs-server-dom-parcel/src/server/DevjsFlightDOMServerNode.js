...
import type {DevjsFormState, Thenable} from 'shared/DevjsTypes';
import type {
  ServerManifest,
  ServerReferenceId,
} from '../client/DevjsFlightClientConfigBundlerParcel';
...
export function decodeFormState<S>(
  actionResult: S,
  body: FormData,
): Promise<DevjsFormState<S, ServerReferenceId> | null> {
