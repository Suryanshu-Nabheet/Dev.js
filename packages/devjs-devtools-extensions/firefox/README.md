...
Modify the source code there and then rebuild this extension by running `node build` from this directory or `pnpm run build:firefox` from the root directory.
