...
const main = async () => {
  ...
  console.log(chalk.gray('\n# From the devjs-devtools root directory:'));
  console.log('pnpm run test:firefox');
  console.log(
  ...
  console.log('WEB_EXT_FIREFOX=nightly pnpm run test:firefox');
  console.log(chalk.gray('\n# You can test against older versions too:'));
  console.log(
    'WEB_EXT_FIREFOX=/Applications/Firefox Developer Edition.app/Contents/MacOS/firefox-bin pnpm run test:firefox'
  );
};
