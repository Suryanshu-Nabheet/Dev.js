...
export const evalScripts: {[key: EvalScriptIds]: EvalScriptEntry} = {
  checkIfDevjsPresentInInspectedWindow: {
    fn: () =>
      window.__devjs_DEVTOOLS_GLOBAL_HOOK__ &&
      window.__devjs_DEVTOOLS_GLOBAL_HOOK__.renderers.size > 0,
    code: () =>
      'window.__devjs_DEVTOOLS_GLOBAL_HOOK__ &&' +
      'window.__devjs_DEVTOOLS_GLOBAL_HOOK__.renderers.size > 0',
  },
  ...
  setBrowserSelectionFromDevjs: {
    ...
    code: () =>
      '(window.__devjs_DEVTOOLS_GLOBAL_HOOK__.$0 !== $0) ?' +
      '(inspect(window.__devjs_DEVTOOLS_GLOBAL_HOOK__.$0), true) :' +
      'false',
  },
  setDevjsSelectionFromBrowser: {
    fn: () => {
    ...
    code: () =>
      '(window.__devjs_DEVTOOLS_GLOBAL_HOOK__ && window.__devjs_DEVTOOLS_GLOBAL_HOOK__.$0 !== $0) ?' +
      '(window.__devjs_DEVTOOLS_GLOBAL_HOOK__.$0 = $0, true) :' +
      'false',
  },
  viewAttributeSource: {
    ...
    code: ({rendererID, elementID, path}) =>
      ...
      'const renderer = window.__devjs_DEVTOOLS_GLOBAL_HOOK__.rendererInterfaces.get(' +
