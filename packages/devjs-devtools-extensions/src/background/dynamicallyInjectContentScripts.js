...
const contentScriptsToInject = [
  ...
  {
    id: '@devjs-devtools/file-fetcher',
  ...
  {
    id: '@devjs-devtools/fallback-eval-context',
  ...
  {
    id: '@devjs-devtools/hook-settings-injector',
...
async function dynamicallyInjectContentScripts() {
  try {
    ...
    // so the hook can be detected by devjs reconciler
