...
const SourceMapIgnoreListPlugin = require('devjs-devtools-shared/SourceMapIgnoreListPlugin');
...
module.exports = {
  ...
  output: {
    ...
    filename: chunkData => {
      switch (chunkData.chunk.name) {
        case 'backend':
          return 'devjs_devtools_backend_compact.js';
        default:
          return '[name].js';
      }
    },
  ...
  plugins: [
    ...
    new Webpack.DefinePlugin({
      ...
      'process.env.DEVTOOLS_PACKAGE': `"devjs-devtools-extensions"`,
    ...
    new Webpack.SourceMapDevToolPlugin({
      filename: '[file].map',
      include: ['installHook.js', 'devjs_devtools_backend_compact.js'],
      noSources: !__DEV__,
    ...
    new SourceMapIgnoreListPlugin({
      shouldIgnoreSource: (assetName, _source) => {
        ...
        const contentScriptNamesToIgnoreList = [
          'devjs_devtools_backend_compact',
              ...
              assets => {
                ...
                for (const [name, asset] of Object.entries(assets)) {
                  ...
                  map.sourcesContent = map.sources.map(sourceName => {
                    ...
                    return (
                      '/*\n' +
                      ' * This script is from Devjs DevTools.\n' +
                      " * You're likely here because you thought it sent an error or warning to the console.\n" +
                      ' * Devjs DevTools patches the console to support features like appending component stacks, \n' +
