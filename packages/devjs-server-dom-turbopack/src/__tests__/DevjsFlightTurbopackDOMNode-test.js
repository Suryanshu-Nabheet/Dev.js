...
describe('DevjsFlightTurbopackDOMNode', () => {
  beforeEach(() => {
    jest.resetModules();
    ...
    jest.resetModules();
    __unmockDevjs();
    jest.unmock('devjs-server-dom-turbopack/server');
    jest.mock('devjs-server-dom-turbopack/client', () =>
      require('devjs-server-dom-turbopack/client.node'),
    );
  ...
  it('should allow an alternative module mapping to be used for SSR', async () => {
    ...
    function ClientRoot() {
      if (!response) {
        response = DevjsServerDOMClient.createFromNodeStream(readable, {
