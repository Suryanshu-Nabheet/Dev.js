...
import type {DevjsSyntheticEvent} from './legacy-events/DevjsSyntheticEventType';
...
import {batchedUpdates} from './legacy-events/DevjsGenericBatching';
import {runEventsInBatch} from './legacy-events/EventBatching';
import getListener from './DevjsNativeGetListener';
import accumulateInto from './legacy-events/accumulateInto';

import {getInstanceFromNode} from './DevjsNativeComponentTree';

export {getListener, registrationNameModules as registrationNames};

/**
 * Version of `DevjsBrowserEventEmitter` that works on the receiving side of a
 ...
 * @see receiveEvent.
 *
 * @param {rootNodeID} rootNodeID Devjs root node ID that event occurred on.
...
function _receiveRootNodeIDEvent(
  ...
  // Devjs Native doesn't use DevjsControlledComponent but if it did, here's
...
): Array<DevjsSyntheticEvent> | DevjsSyntheticEvent | null {
  let events: Array<DevjsSyntheticEvent> | DevjsSyntheticEvent | null = null;
