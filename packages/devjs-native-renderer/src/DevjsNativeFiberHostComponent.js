...
import type {Instance} from './DevjsFiberConfigNative';
...
import {create} from './DevjsNativeAttributePayload';
import {
  mountSafeCallback_NOT_REALLY_SAFE,
  warnForStyleProps,
} from './NativeMethodsMixinUtils';

class DevjsNativeFiberHostComponent implements LegacyPublicInstance {
  ...
  measureLayout(
    ...
    if (typeof relativeToNativeNode === 'number') {
      ...
      const nativeNode: DevjsNativeFiberHostComponent =
...
export default DevjsNativeFiberHostComponent;
