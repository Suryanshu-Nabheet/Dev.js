...
import type {InspectorData, TouchedViewDataAtPoint} from './DevjsNativeTypes';
...
import {create, diff} from './DevjsNativeAttributePayload';
import {
  precacheFiberNode,
  uncacheFiberNode,
  updateFiberProps,
...
import DevjsNativeFiberHostComponent from './DevjsNativeFiberHostComponent';
...
import {enableProfilerTimer} from 'shared/DevjsFeatureFlags';
...
export type Instance = DevjsNativeFiberHostComponent;
...
export * from 'devjs-reconciler/src/DevjsFiberConfigWithNoMicrotasks';
...
export function createInstance(
  ...
  const component = new DevjsNativeFiberHostComponent(
    tag,
    viewConfig,
...
export function insertInContainerBefore(
  ...
  // We create a wrapper object for the container in DevjsNative render()
...
export function getCurrentGestureOffset(provider: GestureTimeline): number {
  throw new Error(
    'startGestureTransition is not yet supported in Devjs Native.',
  );
}

export function clearContainer(container: Container): void {
  // TODO Implement this for Devjs Native
...
export function befodevjsiveInstanceBlur(internalInstanceHandle: Object) {
  // noop
}
