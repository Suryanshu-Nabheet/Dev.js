...
export const rendererPackageName = 'devjs-server-dom-parcel';
...
export * from 'devjs-server-dom-parcel/src/client/DevjsFlightClientConfigBundlerParcel';
export * from 'devjs-server-dom-parcel/src/client/DevjsFlightClientConfigTargetParcelBrowser';
