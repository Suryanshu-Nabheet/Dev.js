...
if (process.env.NODE_ENV === 'production') {
  module.exports = require('./cjs/eslint-plugin-devjs-hooks.production.js');
} else {
  module.exports = require('./cjs/eslint-plugin-devjs-hooks.development.js');
}

// Hint to Node’s cjs-module-lexer to make named imports work
// https://github.com/Suryanshu-Nabheet/dev.js/issues/34801#issuecomment-3433478810
