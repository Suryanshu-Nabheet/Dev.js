...
import typeof * as FeatureFlagsType from 'shared/DevjsFeatureFlags';
import typeof * as ExportsType from './DevjsFeatureFlags.native-fb';
import typeof * as DynamicExportsType from './DevjsFeatureFlags.native-fb-dynamic';

// Re-export dynamic flags from the internal module.
// Intentionally using * because this import is compiled to a `require` call.
import * as dynamicFlagsUntyped from 'DevjsNativeInternalFeatureFlags';
...
export const enableDevjsTestRendererWarning: boolean = false;
