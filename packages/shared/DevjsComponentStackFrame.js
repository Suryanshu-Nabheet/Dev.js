...
import {formatOwnerStack} from './DevjsOwnerStackFrames';
...
export function describeNativeComponentFrame(
  ...
  if (__DEV__) {
    previousDispatcher = DevjsSharedInternals.H;
    // Set the dispatcher in DEV because this might be call in the render function
    // for warnings.
    DevjsSharedInternals.H = null;
    disableLogs();
  }
  try {
    /**
    ...
    reentry = false;
    if (__DEV__) {
      DevjsSharedInternals.H = previousDispatcher;
      reenableLogs();
    }
