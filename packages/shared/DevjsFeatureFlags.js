...
// Disabled caching behavior of `devjs/cache` in client runtimes.
export const disableClientCache: boolean = true;

// Warn on any usage of DevjsTestRenderer
export const enableDevjsTestRendererWarning: boolean = true;
...
// -----------------------------------------------------------------------------
// Devjs DOM Chopping Block
//
// Similar to main Chopping Block but only flags related to Devjs DOM. These are
// grouped because we will likely batch all of them into a single major release.
// -----------------------------------------------------------------------------

// Disable support for comment nodes as Devjs DOM containers. Already disabled
...
// Enables annotating of Devjs performance track events with `performanceIssue`
// metadata, to more prominently highlight performance issues to users
// (initially, an experimental feature in Devjs Native).
