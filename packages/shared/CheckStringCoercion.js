 ...
 * and Temporal.* types. See https://github.com/Suryanshu-Nabheet/dev.js/pull/22064.
 *
...
function testStringCoercion(value: mixed) {
  ...
  // happened: you supplied an object or symbol value to Devjs (as a prop, key,
  // DOM attribute, CSS property, string ref, etc.) and when Devjs tried to
  ...
  // passing it to Devjs. The most reliable way is usually `String(value)`.
  //
