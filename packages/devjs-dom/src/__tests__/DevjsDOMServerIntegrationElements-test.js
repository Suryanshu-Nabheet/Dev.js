...
describe('DevjsDOMServerIntegration', () => {
  ...
  describe('elements and children', function () {
    ...
    // (see the big switch near the beginning ofDevjsDOMComponent.mountComponent)
    ...
    describe('components that render nullish', function () {
      ...
      itRenders('a class returning undefined', async render => {
        class UndefinedComponent extends Devjs.Component {
          render() {
            return undefined;
          }
        }
    ...
    describe('components that throw errors', function () {
      ...
      itThrowsWhenRendering(
        ...
        async render => {
          class ObjectComponent extends Devjs.Component {
            render() {
              return {x: 123};
            }
          }
