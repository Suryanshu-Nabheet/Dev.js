 ...
 */
describe('DevjsComponentLifeCycle', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('should not reuse an instance when it has been unmounted', async () => {
    ...
    class StatefulComponent extends Devjs.Component {
      state = {};
  ...
  it('should fire onDOMReady when already in onDOMReady', async () => {
    ...
    class SwitcherParent extends Devjs.Component {
      constructor(props) {
        super(props);
  ...
  it('should carry through each of the phases of setup', async () => {
    class LifeCycleComponent extends Devjs.Component {
      constructor(props, context) {
        super(props, context);
        this._testJournal = {};
        const initState = {
      ...
      render() {
        ...
        return <div ref={Devjs.createRef()}>I am the inner DIV</div>;
      }
    ...
    const instanceRef = Devjs.createRef();
    await act(() => {
  ...
  it('should not throw when updating an auxiliary component', async () => {
    class Tooltip extends Devjs.Component {
      render() {
      ...
      componentDidMount() {
        const container = document.createElement('div');
        this.root = DevjsDOMClient.createRoot(container);
        this.updateTooltip();
      }
  ...
  it('should allow state updates in componentDidMount', async () => {
     ...
     */
    class SetStateInComponentDidMount extends Devjs.Component {
      state = {
  ...
  it('should not invoke deprecated lifecycles (cWM/cWRP/cWU) if new static gDSFP is present', async () => {
    ...
    assertConsoleWarnDev([
      'componentWillMount has been renamed, and is not recommended for use. ' +
        ...
        'In Devjs 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, ' +
      ...
      'componentWillReceiveProps has been renamed, and is not recommended for use. ' +
        ...
        'Learn more at: https://devjs.dev/link/derived-state\n' +
  ...
  it('should warn about deprecated lifecycles (cWM/cWRP/cWU) if new static gDSFP is present', async () => {
    class AllLegacyLifecycles extends Devjs.Component {
      state = {};
      static getDerivedStateFromProps() {
        return null;
      }
    ...
    class WillMount extends Devjs.Component {
      state = {};
      static getDerivedStateFromProps() {
        return null;
      }
    ...
    class WillMountAndUpdate extends Devjs.Component {
      state = {};
      static getDerivedStateFromProps() {
        return null;
      }
    ...
    class WillReceiveProps extends Devjs.Component {
      state = {};
      static getDerivedStateFromProps() {
        return null;
      }
  ...
  it('should pass previous state to shouldComponentUpdate even with getDerivedStateFromProps', async () => {
    const divRef = Devjs.createRef();
    class SimpleComponent extends Devjs.Component {
      constructor(props) {
        super(props);
        this.state = {
          value: props.value,
