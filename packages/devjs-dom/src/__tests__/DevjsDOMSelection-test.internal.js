...
let Devjs;
let DevjsDOMClient;
let DevjsDOMSelection;
let act;

let getModernOffsetsFromPoints;

describe('DevjsDOMSelection', () => {
  beforeEach(() => {
    Devjs = require('devjs');
    DevjsDOMClient = require('devjs-dom/client');
    DevjsDOMSelection = require('devjs-dom-bindings/src/client/DevjsDOMSelection');
    act = require('internal-test-utils').act;

    ({getModernOffsetsFromPoints} = DevjsDOMSelection);
  });

  // Simple implementation to compare correctness. Devjs's old implementation of
