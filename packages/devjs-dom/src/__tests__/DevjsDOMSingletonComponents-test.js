...
describe('DevjsDOM HostSingleton', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it('renders into html, head, and body persistently so the node identities never change and extraneous styles are retained', async () => {
    ...
    let hydrateRoot = DevjsDOMClient.hydrateRoot(
      document,
      <html data-client-foo="foo">
        <head>
          <title>a client title</title>
    ...
    hydrateRoot = DevjsDOMClient.hydrateRoot(
      document,
      <html data-client-foo="foo">
        <head>
          <link rel="stylesheet" href="resource" />
    ...
    assertConsoleErrorDev([
      "A tree hydrated but some attributes of the server rendered HTML didn't match the client properties. " +
        ...
        'which messes with the HTML before Devjs loaded.\n' +
        '\n' +
  ...
  it('renders single Text children into HostSingletons correctly', async () => {
    ...
    let root = DevjsDOMClient.hydrateRoot(
      document,
      <html>
        <head />
        <body>foo</body>
    ...
    root = DevjsDOMClient.createRoot(document);
    root.render(
      <html>
        <head />
        <body>baz</body>
