...
describe('DevjsLegacyErrorBoundaries', () => {
  let log;
  ...
  beforeEach(() => {
    ...
    BrokenConstructor = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentWillMount = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentDidMount = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentWillReceiveProps = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentWillUpdate = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentDidUpdate = class extends Devjs.Component {
      static defaultProps = {
        errorText: 'Hello',
      };
      constructor(props) {
    ...
    BrokenComponentWillUnmount = class extends Devjs.Component {
      static defaultProps = {
        errorText: 'Hello',
      };
      constructor(props) {
    ...
    BrokenComponentWillMountErrorBoundary = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    BrokenComponentDidMountErrorBoundary = class extends Devjs.Component {
      constructor(props) {
        super(props);
        this.state = {error: null};
    ...
    BrokenRenderErrorBoundary = class extends Devjs.Component {
      constructor(props) {
        super(props);
        this.state = {error: null};
    ...
    BrokenRender = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    NoopErrorBoundary = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    Normal = class extends Devjs.Component {
      static defaultProps = {
        logName: 'Normal',
      };
      constructor(props) {
    ...
    BothErrorBoundaries = class extends Devjs.Component {
      constructor(props) {
        super(props);
        this.state = {error: null};
    ...
    RetryErrorBoundary = class extends Devjs.Component {
      constructor(props) {
        super(props);
    ...
    ErrorMessage = class extends Devjs.Component {
      constructor(props) {
        super(props);
  ...
  it('does not swallow exceptions on mounting without boundaries', async () => {
    ...
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenRender />, container);
      });
    ...
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenComponentWillMount />, container);
      });
    }).rejects.toThrow('Hello');
    ...
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenComponentDidMount />, container);
      });
    }).rejects.toThrow('Hello');
  });
  ...
  it('does not swallow exceptions on updating without boundaries', async () => {
    let container = document.createElement('div');
    DevjsDOM.render(<BrokenComponentWillUpdate />, container);
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenComponentWillUpdate />, container);
      });
    ...
    container = document.createElement('div');
    DevjsDOM.render(<BrokenComponentWillReceiveProps />, container);
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenComponentWillReceiveProps />, container);
      });
    ...
    container = document.createElement('div');
    DevjsDOM.render(<BrokenComponentDidUpdate />, container);
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenComponentDidUpdate />, container);
      });
  ...
  it('does not swallow exceptions on unmounting without boundaries', async () => {
    ...
    DevjsDOM.render(<BrokenComponentWillUnmount />, container);
    await expect(async () => {
      await act(() => {
  ...
  it('prevents errors from leaking into other roots', async () => {
    ...
    DevjsDOM.render(<span>Before 1</span>, container1);
    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<BrokenRender />, container2);
      });
    }).rejects.toThrow('Hello');
    DevjsDOM.render(
      <ErrorBoundary>
    ...
    DevjsDOM.render(<span>After 1</span>, container1);
    DevjsDOM.render(<span>After 2</span>, container2);
    DevjsDOM.render(
    ...
    DevjsDOM.unmountComponentAtNode(container1);
    DevjsDOM.unmountComponentAtNode(container2);
    DevjsDOM.unmountComponentAtNode(container3);
  ...
  it('renders an error state if context provider throws in componentWillMount', () => {
    class BrokenComponentWillMountWithContext extends Devjs.Component {
  ...
  it('resets object refs if mounting aborts', () => {
    ...
    const errorMessageRef = Devjs.createRef();
  ...
  it('can update multiple times in error state', () => {
    ...
    DevjsDOM.render(<div>Other screen</div>, container);
  ...
  it("doesn't get into inconsistent state during removals", () => {
    ...
    DevjsDOM.render(<ErrorBoundary />, container);
    expect(container.textContent).toBe('Caught an error: Hello.');
  ...
  it("doesn't get into inconsistent state during reorders", () => {
    ...
    class MaybeBrokenRender extends Devjs.Component {
      render() {
        if (fail) {
          throw new Error('Hello');
        }
  ...
  it('handles errors that occur in before-mutation commit hook', async () => {
    ...
    const container = document.createElement('div');
    await act(() => {
      DevjsDOM.render(<Parent value={1} />, container);
    });

    await expect(async () => {
      await act(() => {
        DevjsDOM.render(<Parent value={2} />, container);
      });
    }).rejects.toThrow(
      expect.objectContaining({
        errors: [
