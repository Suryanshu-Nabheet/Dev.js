...
describe('DevjsDOMServerIntegration', () => {
  ...
  describe('class contextType', function () {
    ...
    beforeEach(() => {
      Context = Devjs.createContext('none');
    ...
    itRenders('class child with context', async render => {
      class ClassChildWithContext extends Devjs.Component {
    ...
    itRenders('class child without context', async render => {
      class ClassChildWithoutContext extends Devjs.Component {
        render() {
    ...
    itRenders('class child with wrong context', async render => {
      class ClassChildWithWrongContext extends Devjs.Component {
        static contextType = Context;
        render() {
    ...
    itRenders('multiple contexts', async render => {
      const Theme = Devjs.createContext('dark');
      const Language = Devjs.createContext('french');
      class Parent extends Devjs.Component {
        render() {
          return (
      ...
      class ThemeComponent extends Devjs.Component {
      ...
      class LanguageComponent extends Devjs.Component {
    ...
    itRenders('nested context unwinding', async render => {
      ...
      class ThemeConsumer extends Devjs.Component {
        static contextType = Theme;
        render() {
      ...
      class LanguageConsumer extends Devjs.Component {
        static contextType = Language;
        render() {
          return this.props.children(this.context);
        }
