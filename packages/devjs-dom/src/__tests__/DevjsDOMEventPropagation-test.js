...
describe('DevjsDOMEventListener', () => {
  let Devjs;
  let OuterDevjsDOMClient;
  let InnerDevjsDOM;
  let InnerDevjsDOMClient;
  let act;
  let container;
  let root;
  ...
  beforeEach(() => {
    ...
    jest.isolateModules(() => {
      ...
      OuterDevjsDOMClient = require('devjs-dom/client');
    });
    jest.isolateModules(() => {
      InnerDevjsDOM = require('devjs-dom');
      InnerDevjsDOMClient = require('devjs-dom/client');
    });
    expect(OuterDevjsDOMClient).not.toBe(InnerDevjsDOMClient);
  });
  ...
  async function render(tree) {
    ...
    root = OuterDevjsDOMClient.createRoot(container);
    await act(() => {
      root.render(tree);
    });
  }
  ...
  describe('bubbling events', () => {
    it('onAnimationEnd', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onAnimationEnd',
        devjsEventType: 'animationend',
    ...
    it('onAnimationIteration', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onAnimationIteration',
        devjsEventType: 'animationiteration',
    ...
    it('onAnimationStart', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onAnimationStart',
        devjsEventType: 'animationstart',
    ...
    it('onAuxClick', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onAuxClick',
        devjsEventType: 'auxclick',
    ...
    // because we emulate the Devjs 16 behavior where
    ...
    it('onContextMenu', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onContextMenu',
        devjsEventType: 'contextmenu',
    ...
    it('onDoubleClick', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDoubleClick',
        devjsEventType: 'dblclick',
    ...
    it('onDragEnd', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragEnd',
        devjsEventType: 'dragend',
        nativeEvent: 'dragend',
        dispatch(node) {
          node.dispatchEvent(
    ...
    it('onDragEnter', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragEnter',
        devjsEventType: 'dragenter',
    ...
    it('onDragExit', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragExit',
        devjsEventType: 'dragexit',
    ...
    it('onDragLeave', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragLeave',
        devjsEventType: 'dragleave',
    ...
    it('onDragOver', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragOver',
        devjsEventType: 'dragover',
    ...
    it('onDragStart', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onDragStart',
        devjsEventType: 'dragstart',
    ...
    it('onGotPointerCapture', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onGotPointerCapture',
        devjsEventType: 'gotpointercapture',
    ...
    it('onKeyDown', async () => {
      await testNativeBubblingEvent({
        type: 'input',
        devjsEvent: 'onKeyDown',
        devjsEventType: 'keydown',
        nativeEvent: 'keydown',
        dispatch(node) {
          node.dispatchEvent(
    ...
    it('onKeyPress', async () => {
      await testNativeBubblingEvent({
        type: 'input',
        devjsEvent: 'onKeyPress',
        devjsEventType: 'keypress',
    ...
    it('onLostPointerCapture', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onLostPointerCapture',
        devjsEventType: 'lostpointercapture',
    ...
    it('onMouseDown', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onMouseDown',
        devjsEventType: 'mousedown',
    ...
    it('onMouseOut', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onMouseOut',
        devjsEventType: 'mouseout',
    ...
    it('onMouseOver', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onMouseOver',
        devjsEventType: 'mouseover',
    ...
    it('onMouseUp', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onMouseUp',
        devjsEventType: 'mouseup',
        nativeEvent: 'mouseup',
        dispatch(node) {
          node.dispatchEvent(
    ...
    it('onPointerCancel', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerCancel',
        devjsEventType: 'pointercancel',
    ...
    it('onPointerDown', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerDown',
        devjsEventType: 'pointerdown',
    ...
    it('onPointerMove', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerMove',
        devjsEventType: 'pointermove',
    ...
    it('onPointerOut', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerOut',
        devjsEventType: 'pointerout',
    ...
    it('onPointerOver', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerOver',
        devjsEventType: 'pointerover',
    ...
    it('onPointerUp', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onPointerUp',
        devjsEventType: 'pointerup',
    ...
    it('onTouchCancel', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTouchCancel',
        devjsEventType: 'touchcancel',
    ...
    it('onTouchEnd', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTouchEnd',
        devjsEventType: 'touchend',
    ...
    it('onTouchMove', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTouchMove',
        devjsEventType: 'touchmove',
    ...
    it('onTouchStart', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTouchStart',
        devjsEventType: 'touchstart',
    ...
    it('onTransitionRun', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTransitionRun',
        devjsEventType: 'transitionrun',
    ...
    it('onTransitionStart', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTransitionStart',
        devjsEventType: 'transitionstart',
    ...
    it('onTransitionCancel', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTransitionCancel',
        devjsEventType: 'transitioncancel',
    ...
    it('onTransitionEnd', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onTransitionEnd',
        devjsEventType: 'transitionend',
    ...
    it('onFullscreenChange', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onFullscreenChange',
        devjsEventType: 'fullscreenchange',
    ...
    it('onFullscreenError', async () => {
      await testNativeBubblingEvent({
        type: 'div',
        devjsEvent: 'onFullscreenError',
        devjsEventType: 'fullscreenerror',
  ...
  describe('non-bubbling events that bubble in Devjs', () => {
    it('onAbort', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onAbort',
        devjsEventType: 'abort',
        nativeEvent: 'abort',
        dispatch(node) {
    ...
    it('onCanPlay', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onCanPlay',
        devjsEventType: 'canplay',
        nativeEvent: 'canplay',
        dispatch(node) {
    ...
    it('onCanPlayThrough', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onCanPlayThrough',
        devjsEventType: 'canplaythrough',
    ...
    it('onDurationChange', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onDurationChange',
        devjsEventType: 'durationchange',
    ...
    it('onEmptied', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onEmptied',
        devjsEventType: 'emptied',
        nativeEvent: 'emptied',
        dispatch(node) {
    ...
    it('onEncrypted', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onEncrypted',
        devjsEventType: 'encrypted',
    ...
    it('onInvalid', async () => {
      await testEmulatedBubblingEvent({
        type: 'input',
        devjsEvent: 'onInvalid',
        devjsEventType: 'invalid',
        nativeEvent: 'invalid',
        dispatch(node) {
    ...
    it('onLoadedData', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onLoadedData',
        devjsEventType: 'loadeddata',
    ...
    it('onLoadedMetadata', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onLoadedMetadata',
        devjsEventType: 'loadedmetadata',
    ...
    it('onLoadStart', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onLoadStart',
        devjsEventType: 'loadstart',
    ...
    it('onPlaying', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onPlaying',
        devjsEventType: 'playing',
        nativeEvent: 'playing',
        dispatch(node) {
    ...
    it('onProgress', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onProgress',
        devjsEventType: 'progress',
    ...
    it('onRateChange', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onRateChange',
        devjsEventType: 'ratechange',
    ...
    it('onSeeking', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onSeeking',
        devjsEventType: 'seeking',
        nativeEvent: 'seeking',
        dispatch(node) {
    ...
    it('onStalled', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onStalled',
        devjsEventType: 'stalled',
        nativeEvent: 'stalled',
        dispatch(node) {
    ...
    it('onSuspend', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onSuspend',
        devjsEventType: 'suspend',
        nativeEvent: 'suspend',
        dispatch(node) {
    ...
    it('onTimeUpdate', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onTimeUpdate',
        devjsEventType: 'timeupdate',
    ...
    it('onBeforeToggle Popover API', async () => {
      await testEmulatedBubblingEvent({
        ...
        devjsEvent: 'onBeforeToggle',
        devjsEventType: 'beforetoggle',
    ...
    it('onVolumeChange', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onVolumeChange',
        devjsEventType: 'volumechange',
    ...
    it('onWaiting', async () => {
      await testEmulatedBubblingEvent({
        type: 'video',
        devjsEvent: 'onWaiting',
        devjsEventType: 'waiting',
        nativeEvent: 'waiting',
        dispatch(node) {
  ...
  describe('non-bubbling events that do not bubble in Devjs', () => {
    it('onScroll', async () => {
      await testNonBubblingEvent({
        type: 'div',
        devjsEvent: 'onScroll',
        devjsEventType: 'scroll',
        nativeEvent: 'scroll',
        dispatch(node) {
    ...
    it('onScrollEnd', async () => {
      await testNonBubblingEvent({
        type: 'div',
        devjsEvent: 'onScrollEnd',
        devjsEventType: 'scrollend',
  ...
  describe('enter/leave events', () => {
    it('onMouseEnter and onMouseLeave', async () => {
      const log = [];
      const targetRef = Devjs.createRef();
      await render(
        <Fixture
          type="div"
          targetRef={targetRef}
  ...
  describe('polyfilled events', () => {
    ...
    it('onChange', async () => {
      ...
      // The outer Devjs doesn't receive the event at all
  ...
  // Events that bubble in Devjs and in the browser.
  // Devjs delegates them to the root.
  async function testNativeBubblingEvent(config) {
    ...
    await testDevjsStopPropagationInOuterCapturePhase(config);
    await testDevjsStopPropagationInInnerCapturePhase(config);
    await testDevjsStopPropagationInInnerBubblePhase(config);
    await testDevjsStopPropagationInOuterBubblePhase(config);
  ...
  // Events that bubble in Devjs but not in the browser.
  // Devjs attaches them to the elements.
  ...
  // Events that don't bubble either in Devjs or in the browser.
  ...
  async function testNativeBubblingEventWithTargetListener(eventConfig) {
    ...
    await render(
      <Fixture
        ...
        targetRef={targetRef}
        targetProps={{
          [eventConfig.devjsEvent]: e => {
            log.push('---- inner');
          },
          [eventConfig.devjsEvent + 'Capture']: e => {
            log.push('---- inner capture');
          },
        }}
        parentProps={{
        ...
        outerParentProps={{
          ...
          [eventConfig.devjsEvent + 'Capture']: e => {
            expect(e.type).toBe(eventConfig.devjsEventType);
            log.push('- outer parent capture');
          },
        }}
      />,
  ...
  async function testEmulatedBubblingEventWithTargetListener(eventConfig) {
    ...
    expect(log.length).toBe(0);
    eventConfig.dispatch(targetRef.current);
    // This event doesn't bubble natively, but Devjs emulates it.
    // Since the element is created by the inner Devjs, the bubbling
    // stops at the inner parent and never reaches the outer Devjs.
  ...
  async function testNonBubblingEventWithTargetListener(eventConfig) {
    ...
    expect(log.length).toBe(0);
    eventConfig.dispatch(targetRef.current);
    // This event doesn't bubble natively, and Devjs is
  ...
  async function testNonBubblingEventWithoutTargetListener(eventConfig) {
    ...
    expect(log.length).toBe(0);
    eventConfig.dispatch(targetRef.current);
    // This event doesn't bubble native, and Devjs doesn't
  ...
  async function testDevjsStopPropagationInOuterCapturePhase(eventConfig) {
    const log = [];
    const targetRef = Devjs.createRef();
    await render(
      <Fixture
  ...
  async function testDevjsStopPropagationInInnerCapturePhase(eventConfig) {
    const log = [];
    const targetRef = Devjs.createRef();
    await render(
      <Fixture
  ...
  async function testDevjsStopPropagationInInnerBubblePhase(eventConfig) {
    const log = [];
    const targetRef = Devjs.createRef();
    await render(
      <Fixture
  ...
  async function testDevjsStopPropagationInOuterBubblePhase(eventConfig) {
    const log = [];
    const targetRef = Devjs.createRef();
    await render(
      <Fixture
  ...
  async function testNativeStopPropagationInInnerCapturePhase(eventConfig) {
    ...
    // all Devjs capture phase listeners should run.
    // But then the native handler stops propagation
    // so none of the bubbling Devjs handlers would run.
    expect(log).toEqual(unindent`
      - outer parent capture
      -- outer capture
      --- inner parent capture
  ...
  async function testNativeStopPropagationInOuterBubblePhase(eventConfig) {
    ...
    // As a result, it never reaches the outer Devjs root,
    // and thus the outer Devjs event handlers don't fire.
    expect(log).toEqual(unindent`
      - outer parent capture
      -- outer capture
      --- inner parent capture
  ...
  function Fixture({
    ...
    return (
      <Outer
        ...
        <NestedDevjs>{inner}</NestedDevjs>
      </Outer>
    );
  }

  function NestedDevjs({children}) {
    const ref = Devjs.useRef();
    Devjs.useLayoutEffect(() => {
      const parent = ref.current;
      const innerContainer = document.createElement('div');
      parent.appendChild(innerContainer);
      const innerDevjsRoot = InnerDevjsDOMClient.createRoot(innerContainer);
      InnerDevjsDOM.flushSync(() => {
        innerDevjsRoot.render(children);
      });
      return () => {
        innerDevjsRoot.unmount();
