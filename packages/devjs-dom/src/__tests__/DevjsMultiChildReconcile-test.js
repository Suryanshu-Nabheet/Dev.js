 ...
 */
class StatusDisplay extends Devjs.Component {
 ...
 */
class FriendsStatusDisplay extends Devjs.Component {
  displays = {};
...
describe('DevjsMultiChildReconcile', () => {
  beforeEach(() => {
    jest.resetModules();
  });
   ...
   * of `FriendsStatusDisplay`, nothing related to Devjs or these test cases.
   */
