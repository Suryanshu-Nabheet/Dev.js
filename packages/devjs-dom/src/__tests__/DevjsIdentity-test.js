...
describe('DevjsIdentity', () => {
  ...
  async function renderAComponentWithKeyIntoContainer(key, root) {
    ...
    const wrapperRef = Devjs.createRef();
    await act(async () => {
  ...
  it('should allow any character as a key, in a detached parent', async () => {
    ...
    const root = DevjsDOMClient.createRoot(detachedContainer);
  ...
  it('should allow any character as a key, in an attached parent', async () => {
    ...
    const root = DevjsDOMClient.createRoot(attachedContainer);
  ...
  it('should let restructured components retain their uniqueness', async () => {
    ...
    class TestContainer extends Devjs.Component {
      render() {
        return (
          <TestComponent>
            {instance0}
  ...
  it('should retain key during updates in composite components', async () => {
    ...
    const container = document.createElement('div');
    const root = DevjsDOMClient.createRoot(container);
    const wrappedRef = Devjs.createRef();
    await act(async () => {
      root.render(
