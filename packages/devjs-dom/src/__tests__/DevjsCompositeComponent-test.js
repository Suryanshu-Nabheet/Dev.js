...
describe('DevjsCompositeComponent', () => {
  ...
  beforeEach(() => {
    ...
    DevjsSharedInternals =
      require('devjs').__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  ...
  describe('MorphingComponent', () => {
    ...
    beforeEach(() => {
      MorphingComponent = class extends Devjs.Component {
        state = {activated: false};
        xRef = Devjs.createRef();
       ...
       * reallocated again.
       */
      ChildUpdates = class extends Devjs.Component {
        anchorRef = Devjs.createRef();
    ...
    it('should devjs to state changes from callbacks', async () => {
  ...
  it('should not support module pattern components', async () => {
    ...
    await expect(async () => {
      ...
      'Objects are not valid as a Devjs child (found: object with keys {render}).',
    );
  ...
  it('should warn when rendering a class with a render method that does not extend Devjs.Component', async () => {
    const container = document.createElement('div');
  ...
  it('should cleanup even if render() fatals', async () => {
    ...
    class BadComponent extends Devjs.Component {
      render() {
        // Stash the dispatcher that was available in render so we can check
        // that its internals also reset.
        stashedDispatcher = DevjsSharedInternals.A;
        throw new Error();
      }
    }

    const instance = <BadComponent />;
    expect(DevjsSharedInternals.A).toBe(null);
  ...
  it('should only call componentWillUnmount once', async () => {
    ...
    class UnunmountableComponent extends Devjs.Component {
      componentWillUnmount() {
        app.setState({});
        count++;
  ...
  it('prepares new child before unmounting old', async () => {
    class Spy extends Devjs.Component {
  ...
  it('respects a shallow shouldComponentUpdate implementation', async () => {
    class PlasticWrap extends Devjs.Component {
      constructor(props, context) {
        super(props, context);
        this.state = {
          color: 'green',
        };
        this.appleRef = Devjs.createRef();
      }
    ...
    class Apple extends Devjs.Component {
      state = {
        cut: false,
        slices: 1,
      };
  ...
  it('should return a meaningful warning when constructor is returned', async () => {
    class RenderTextInvalidConstructor extends Devjs.Component {
      constructor(props) {
        super(props);
  ...
  it('should return error if render is not defined', async () => {
    class RenderTestUndefinedRender extends Devjs.Component {}
  ...
  // https://github.com/Suryanshu-Nabheet/dev.js/issues/13580
  it('should support classes shadowing isDevjsComponent', async () => {
    class Shadow extends Devjs.Component {
      isDevjsComponent() {}
      render() {
        return <div />;
      }
  ...
  it('should not warn on updating function component from componentWillMount', async () => {
    ...
    let ref;
    function A() {
      const [state, _setState] = Devjs.useState(null);
      setState = _setState;
  ...
  it('should not warn on updating function component from componentWillUpdate', async () => {
    ...
    let ref;
    function A() {
      const [state, _setState] = Devjs.useState();
      setState = _setState;
      return <div ref={r => (ref = r)}>{state}</div>;
    }
    class B extends Devjs.Component {
