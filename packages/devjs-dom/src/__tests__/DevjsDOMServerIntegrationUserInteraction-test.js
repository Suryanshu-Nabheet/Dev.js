...
describe('DevjsDOMServerIntegrationUserInteraction', () => {
  let ControlledInput, ControlledTextArea, ControlledCheckbox, ControlledSelect;

  beforeEach(() => {
    resetModules();
    ControlledInput = class extends Devjs.Component {
      static defaultProps = {
        type: 'text',
        initialValue: 'Hello',
      };
    ...
    ControlledTextArea = class extends Devjs.Component {
      constructor() {
        super();
    ...
    ControlledCheckbox = class extends Devjs.Component {
      constructor() {
        super();
    ...
    ControlledSelect = class extends Devjs.Component {
      constructor() {
        super();
        this.state = {value: 'Hello'};
      }
  ...
  describe('user interaction with inputs before client render', function () {
    ...
    // DevjsDOM.render is called. the client render should NOT blow away
