...
describe('ref swapping', () => {
  let RefHopsAround;
  beforeEach(() => {
    RefHopsAround = class extends Devjs.Component {
      container = null;
      state = {count: 0};
      hopRef = Devjs.createRef();
      divOneRef = Devjs.createRef();
      divTwoRef = Devjs.createRef();
      divThreeRef = Devjs.createRef();
...
describe('useImerativeHandle refs', () => {
  const ImperativeHandleComponent = Devjs.forwardRef(({name}, ref) => {
