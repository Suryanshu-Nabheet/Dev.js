...
describe('DevjsMultiChild', () => {
  ...
  describe('reconciliation', () => {
    ...
    it('should NOT replace children with different owners', async () => {
      ...
      class WrapperComponent extends Devjs.Component {
        render() {
  ...
  it('should reorder bailed-out children', async () => {
    class LetterInner extends Devjs.Component {
      render() {
        return <div>{this.props.char}</div>;
      }
    }

    class Letter extends Devjs.Component {
      render() {
    ...
    class Letters extends Devjs.Component {
      render() {
