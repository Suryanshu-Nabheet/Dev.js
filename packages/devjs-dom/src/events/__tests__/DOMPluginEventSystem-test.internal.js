    ...
    describe(
      ...
      () => {
        ...
        beforeEach(() => {
          ...
          DevjsFeatureFlags.enableLegacyFBSupport = enableLegacyFBSupport;
        ...
        it('handle propagation of click events combined with sync clicks', async () => {
          ...
          function Test() {
            const inputRef = Devjs.useRef(null);
            return (
              <div>
                <button
                  ref={buttonRef}
        ...
        it('handle propagation of click events between roots', async () => {
          const buttonRef = Devjs.createRef();
          const divRef = Devjs.createRef();
          const childRef = Devjs.createRef();
          const log = [];
          const onClick = jest.fn(e => log.push(['bubble', e.currentTarget]));
          const onClickCapture = jest.fn(e =>
            log.push(['capture', e.currentTarget]),
          ...
          const childRoot = DevjsDOMClient.createRoot(childRef.current);
          await act(() => {
        ...
        it('handle propagation of click events between disjointed roots', async () => {
          ...
          const disjointedNodeRoot = DevjsDOMClient.createRoot(disjointedNode);
          await act(() => {
        ...
        it('handle propagation of click events between disjointed roots #2', async () => {
          const buttonRef = Devjs.createRef();
          const button2Ref = Devjs.createRef();
          const divRef = Devjs.createRef();
          ...
          const parentRoot = DevjsDOMClient.createRoot(parentContainer);
          await act(() => {
            parentRoot.render(<Parent />);
          });
          const childRoot = DevjsDOMClient.createRoot(childContainer);
          await act(() => {
            childRoot.render(<Child />);
          });
          ...
          function Parent() {
            return (
              <button
                ...
                onClick={onClick}
                onClickCapture={onClickCapture}>
                {DevjsDOM.createPortal(<Child />, portalElement)}
              </button>
            );
          }
        ...
        it('does not invoke an event on a parent tree when a subtree is dehydrated', async () => {
          ...
          let clicks = 0;
          const childSlotRef = Devjs.createRef();
          ...
          suspend = false;
          const finalHTML = DevjsDOMServer.renderToString(<App />);
          ...
          // This lets us detect whether an event goes through Devjs's event system.
          const parentRoot = DevjsDOMClient.createRoot(parentContainer);
          await act(() => {
            parentRoot.render(<Parent />);
          });
          ...
          await act(() => {
            DevjsDOMClient.hydrateRoot(childContainer, <App />);
          });
        ...
        it('handle click events on dynamic portals', async () => {
          ...
          function Parent() {
            const ref = Devjs.useRef(null);
            const [portal, setPortal] = Devjs.useState(null);
        ...
        it('native stopPropagation on click events between portals', async () => {
          const buttonRef = Devjs.createRef();
          const divRef = Devjs.createRef();
          const middleDivRef = Devjs.createRef();
          const log = [];
          const onClick = jest.fn(e => log.push(['bubble', e.currentTarget]));
          const onClickCapture = jest.fn(e =>
            log.push(['capture', e.currentTarget]),
        ...
        it('handle propagation of enter and leave events between portals #2', async () => {
          const buttonRef = Devjs.createRef();
          const divRef = Devjs.createRef();
          const portalRef = Devjs.createRef();
          const log = [];
          const onMouseEnter = jest.fn(e => log.push(e.currentTarget));
          const onMouseLeave = jest.fn(e => log.push(e.currentTarget));
          ...
          function Parent() {
            ...
            Devjs.useLayoutEffect(() => {
              setPortal(DevjsDOM.createPortal(<Child />, portalRef.current));
            }, []);
        ...
        it('should preserve bubble/capture order between roots and nested portals', async () => {
          ...
          function Root() {
            const portalTargetRef = Devjs.useRef(null);
            Devjs.useLayoutEffect(() => {
            ...
            return (
              <div onClick={onClickRoot} onClickCapture={onClickCaptureRoot}>
                ...
                {DevjsDOM.createPortal(<Portal />, portalContainer)}
              </div>
            );
          }
          ...
          if (enableLegacyFBSupport) {
            ...
            expect(log).toEqual([
              // The events on root probably shouldn't fire if a non-Devjs intermediated. but current behavior is that they do.
              'capture root',
              'capture portal',
              'bubble portal',
              'bubble root',
        ...
        describe('DevjsDOM.createEventHandle', () => {
          beforeEach(() => {
            jest.resetModules();
            DevjsFeatureFlags = require('shared/DevjsFeatureFlags');
            DevjsFeatureFlags.enableLegacyFBSupport = enableLegacyFBSupport;
            DevjsFeatureFlags.enableCreateEventHandleAPI = true;
          ...
          // @gate www
          it('can render correctly with the DevjsDOMServer', () => {
            const clickEvent = jest.fn();
            const setClick = DevjsDOM.unstable_createEventHandle('click');

            function Test() {
              const divRef = Devjs.useRef(null);
            ...
            const output = DevjsDOMServer.renderToString(<Test />);
            expect(output).toBe(`<div>Hello world</div>`);
          });

          // @gate www
          it('can render correctly with the DevjsDOMServer hydration', async () => {
            const clickEvent = jest.fn();
            const spanRef = Devjs.createRef();
            const setClick = DevjsDOM.unstable_createEventHandle('click');
            ...
            await act(() => {
              DevjsDOMClient.hydrateRoot(container, <Test />);
            });
          ...
          it('should correctly work for a basic "click" listener', async () => {
            ...
            const setClick2 = DevjsDOM.unstable_createEventHandle('click');
          ...
          it('handle propagation of click events', async () => {
            ...
            const setClick = DevjsDOM.unstable_createEventHandle('click');
            const setCaptureClick = DevjsDOM.unstable_createEventHandle(
              'click',
              {
                capture: true,
              },
          ...
          it('handle propagation of click events mixed with onClick events', async () => {
            ...
            const setClick = DevjsDOM.unstable_createEventHandle('click');
            const setClickCapture = DevjsDOM.unstable_createEventHandle(
              'click',
              {
                capture: true,
              },
          ...
          it('should correctly handle many nested target listeners', async () => {
            ...
            let setClick1 = DevjsDOM.unstable_createEventHandle('click', {
              capture: true,
            });
            let setClick2 = DevjsDOM.unstable_createEventHandle('click', {
              capture: true,
            });
            let setClick3 = DevjsDOM.unstable_createEventHandle('click');
            let setClick4 = DevjsDOM.unstable_createEventHandle('click');
            ...
            setClick1 = DevjsDOM.unstable_createEventHandle('click');
            setClick2 = DevjsDOM.unstable_createEventHandle('click');
            setClick3 = DevjsDOM.unstable_createEventHandle('click');
            setClick4 = DevjsDOM.unstable_createEventHandle('click');
          ...
          it('should correctly handle stopPropagation correctly for target events', async () => {
            ...
            const divRef = Devjs.createRef();
            const clickEvent = jest.fn();
            const setClick1 = DevjsDOM.unstable_createEventHandle('click', {
              bind: buttonRef,
            });
            const setClick2 = DevjsDOM.unstable_createEventHandle('click');
          ...
          it('should correctly handle stopPropagation correctly for many target events', async () => {
            ...
            const setClick1 = DevjsDOM.unstable_createEventHandle('click');
            const setClick2 = DevjsDOM.unstable_createEventHandle('click');
            const setClick3 = DevjsDOM.unstable_createEventHandle('click');
            const setClick4 = DevjsDOM.unstable_createEventHandle('click');
          ...
          it('does not support custom user events', () => {
            ...
            expect(() => {
              DevjsDOM.unstable_createEventHandle('custom-event');
            }).toThrow(
              'Cannot call unstable_createEventHandle with "custom-event", as it is not an event known to Devjs.',
            );
          });
          ...
          it('beforeblur and afterblur are called after a focused element is unmounted', async () => {
            ...
            const innerRef2 = Devjs.createRef();
            const setAfterBlurHandle =
              DevjsDOM.unstable_createEventHandle('afterblur');
            const setBeforeBlurHandle =
              DevjsDOM.unstable_createEventHandle('beforeblur');
          ...
          it('beforeblur and afterblur are called after a focused element is suspended', async () => {
            ...
            const root = DevjsDOMClient.createRoot(container2);
          ...
          it('handle propagation of click events between disjointed comment roots', async () => {
            ...
            const disjointedNodeRoot =
              DevjsDOMClient.createRoot(disjointedNode);
            await act(() => {
              disjointedNodeRoot.render(<Child />);
            });
          ...
          describe('Compatibility with Scopes API', () => {
            beforeEach(() => {
              ...
              DevjsFeatureFlags = require('shared/DevjsFeatureFlags');
              DevjsFeatureFlags.enableCreateEventHandleAPI = true;
              DevjsFeatureFlags.enableScopeAPI = true;
            ...
            it('handle propagation of click events on a scope', async () => {
              ...
              const TestScope = Devjs.unstable_Scope;
              const setClick = DevjsDOM.unstable_createEventHandle('click');
              const setClickCapture = DevjsDOM.unstable_createEventHandle(
                'click',
                {
              ...
              function Test() {
                const scopeRef = Devjs.useRef(null);
            ...
            it('handle stopPropagation (inner) correctly between scopes', async () => {
              ...
              const TestScope = Devjs.unstable_Scope;
              const TestScope2 = Devjs.unstable_Scope;
              const setClick = DevjsDOM.unstable_createEventHandle('click');

              function Test() {
                const scopeRef = Devjs.useRef(null);
                const scope2Ref = Devjs.useRef(null);
            ...
            it('should be able to register handlers for events affected by the intervention', async () => {
              ...
              const ref = Devjs.createRef();
              const setTouchStart =
                DevjsDOM.unstable_createEventHandle('touchstart');
              const setTouchMove =
                DevjsDOM.unstable_createEventHandle('touchmove');
              const setWheel = DevjsDOM.unstable_createEventHandle('wheel');
              ...
              const root = DevjsDOMClient.createRoot(rootContainer);
              await act(() => {
                root.render(<Component />);
              });
