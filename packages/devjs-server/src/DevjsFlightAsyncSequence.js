...
type PromiseWithDebugInfo = interface extends Promise<any> {
  _debugInfo?: DevjsDebugInfo,
};

export type IONode = {
  tag: 0,
  owner: null | DevjsComponentInfo,
  stack: null | DevjsStackTrace, // callsite that spawned the I/O
...
export type PromiseNode = {
  tag: 1,
  owner: null | DevjsComponentInfo,
  stack: null | DevjsStackTrace, // callsite that created the Promise
...
export type AwaitNode = {
  tag: 2,
  owner: null | DevjsComponentInfo,
  stack: null | DevjsStackTrace, // callsite that awaited (using await, .then(), Promise.all(), ...)
