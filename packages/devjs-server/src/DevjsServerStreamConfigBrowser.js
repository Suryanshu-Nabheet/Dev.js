...
export function stringToPrecomputedChunk(content: string): PrecomputedChunk {
  ...
  if (__DEV__) {
    if (precomputedChunk.byteLength > VIEW_SIZE) {
      console.error(
        'precomputed chunks must be smaller than the view size configured for this host. This is a bug in Devjs.',
      );
    }
  }
...
export {createFastHashJS as createFastHash} from 'devjs-server/src/createFastHashJS';
