...
import type {DevjsComponentInfo, DevjsAsyncInfo} from 'shared/DevjsTypes';
...
} from 'shared/DevjsComponentStackFrame';
...
import {formatOwnerStack} from 'shared/DevjsOwnerStackFrames';
...
export type ComponentStackNode = {
  ...
  type:
    ...
    | DevjsComponentInfo
    | DevjsAsyncInfo,
  owner?: null | DevjsComponentInfo | ComponentStackNode, // DEV only
...
export function getOwnerStackByComponentStackNodeInDev(
  ...
  try {
    ...
    let owner: void | null | ComponentStackNode | DevjsComponentInfo =
      componentStack;
    ...
    while (owner) {
      ...
      // in a Devjs render but in some imperative bootstrapping code. It could be useful
