...
import {emptyContextObject} from './DevjsFizzLegacyContext';
import {readContext} from './DevjsFizzNewContext';

import {disableLegacyContext} from 'shared/DevjsFeatureFlags';
...
function warnNoop(
  ...
  if (__DEV__) {
    ...
    const componentName =
      (constructor && getComponentNameFromType(constructor)) || 'DevjsClass';
      ...
      if (instance.contextTypes) {
        console.error(
          'contextTypes was defined as an instance property on %s. Use a static ' +
            'property to define contextTypes instead. (https://devjs.dev/link/legacy-context)',
          name,
        );
      }
    ...
    if (__DEV__) {
      if (instance.componentWillMount.__suppressDeprecationWarning !== true) {
        ...
        if (!didWarnAboutDeprecatedWillMount[componentName]) {
          console.warn(
            // keep this warning in sync with DevjsStrictModeWarning.js
