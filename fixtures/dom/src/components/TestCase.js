...
class TestCase extends Devjs.Component {
      ...
      <section className={cn('test-case', complete && 'test-case--complete')}>
        ...
        <dl className="test-case__details">
          ...
          {introducedIn && (
            <dd>
              <a
                href={'https://github.com/Suryanshu-Nabheet/dev.js/tag/v' + introducedIn}>
          ...
          {resolvedIn && (
            <dd>
              <a href={'https://github.com/Suryanshu-Nabheet/dev.js/tag/v' + resolvedIn}>
          ...
          {resolvedBy && (
            <dd>
              <a
                href={
                  'https://github.com/Suryanshu-Nabheet/dev.js/pull/' +
                  resolvedBy.slice(1)
                }>
        ...
        <div className="test-case__body">
          {!isTestFixed && (
            <p className="test-case__invalid-version">
              ...
              of Devjs. This test is not expected to pass for the selected
...
TestCase.Steps = class extends Devjs.Component {
  render() {
...
TestCase.ExpectedResult = class extends Devjs.Component {
  render() {
    const {children} = this.props;
    return (
      <div>
