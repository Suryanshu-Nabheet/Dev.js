...
class SuspendyTreeChild extends Devjs.Component {
...
class SuspendyTree extends Devjs.Component {
  parentContainer = Devjs.createRef(null);
  container = Devjs.createRef(null);
  componentDidMount() {
    this.setState({});
    document.addEventListener('keydown', this.onKeydown);
  }
...
class TextInputFixtures extends Devjs.Component {
  render() {
    return (
      <FixtureSet
        title="Suspense"
