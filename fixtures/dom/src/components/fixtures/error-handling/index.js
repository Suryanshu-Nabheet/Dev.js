...
class BadDidMount extends Devjs.Component {
  componentDidMount() {
    this.props.doThrow();
  }
...
class TriggerErrorAndCatch extends Devjs.Component {
...
class SilenceErrors extends Devjs.Component {
  state = {
    silenceErrors: false,
  };
  componentDidMount() {
...
class GetEventTypeDuringUpdate extends Devjs.Component {
  state = {};
...
class SilenceRecoverableError extends Devjs.Component {
  render() {
    return (
      <SilenceErrors>
        <ErrorBoundary
...
class TrySilenceFatalError extends Devjs.Component {
  container = document.createElement('div');
...
export default class ErrorHandlingTestCases extends Devjs.Component {
  render() {
    return (
      <FixtureSet title="Error handling">
        <TestCase
          title="Break on uncaught exceptions"
          description="In DEV, errors should be treated as uncaught, even though Devjs catches them internally">
          <TestCase.Steps>
        ...
        <TestCase
          ...
          <TestCase.ExpectedResult>
            ...
            Devjs. You should also see our addendum ("The above error...").
          </TestCase.ExpectedResult>
