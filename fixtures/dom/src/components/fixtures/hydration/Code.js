...
export class CodeEditor extends Devjs.Component {
 ...
 * See https://github.com/Suryanshu-Nabheet/dev.js/issues/13610
 */
const supportsDetails = !(
  document.createElement('details') instanceof HTMLUnknownElement
);

export class CodeError extends Devjs.Component {
  render() {
