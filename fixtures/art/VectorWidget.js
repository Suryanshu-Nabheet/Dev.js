...
var Circle = require('devjs-art/Circle');
var Devjs = require('devjs');
var DevjsART = require('devjs-art');
var Group = DevjsART.Group;
var Shape = DevjsART.Shape;
var Surface = DevjsART.Surface;
var Transform = DevjsART.Transform;
 ...
 */
class VectorWidget extends Devjs.Component {
  /**
   ...
   * method. Binding of `this.onTick` is not needed because all Devjs methods
  ...
  /**
   * This is the "main" method for any component. The Devjs API allows you to
  ...
  /**
   * Better SVG support for Devjs coming soon.
   */
