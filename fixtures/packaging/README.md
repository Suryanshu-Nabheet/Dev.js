...
This folder exists for **Devjs contributors** only.  
If you use Devjs, you don't need to worry about it.

These fixtures verify that the built Devjs distributions are usable in different environments.  
**They are not running automatically.** (At least not yet. Feel free to contribute to automate them.)

Run them when you make changes to how we package Devjs and DevjsDOM.

## How to Run

First, build Devjs and the fixtures:
