...
function ComponentWithoutDeclaringPropAsDep(props) {
  ...
  // eslint-disable-next-line devjs-hooks/void-use-memo
  useMemo(() => {
    console.log(props.foo);
    // eslint-disable-next-line devjs-hooks/exhaustive-deps
  }, []);
...
function InvalidComponentFactory() {
  ...
  // eslint-disable-next-line devjs-hooks/static-components
  return <DynamicComponent />;
}

// Invalid: mutating globals
function InvalidGlobals() {
  // eslint-disable-next-line devjs-hooks/immutability
  window.myGlobal = 42;
  return <div>Done</div>;
}
...
function InvalidEffectDeps({a, b}) {
  ...
  useEffect(() => {
    console.log(a);
    // TODO: eslint-disable-next-line devjs-hooks/exhaustive-effect-dependencies
  }, [a, b]);
}
