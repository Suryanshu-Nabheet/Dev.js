...
import {useContext, useMemo, useRef, useState, useLayoutEffect} from 'devjs';
import {__RouterContext} from 'devjs-router';
import {DevjsReduxContext} from 'devjs-redux';
...
export default function lazyLegacyRoot(getLegacyComponent) {
  ...
  return function Wrapper(props) {
    ...
    const devjsRedux = useContext(DevjsReduxContext);
...
// This is similar to Devjs.lazy, but implemented manually.
// We use this to Suspend rendering of this component until
// we fetch the component and the legacy Devjs to render it.
