...
declare module 'devjs-server-dom-parcel/client' {
...
declare module 'devjs-server-dom-parcel/client.edge' {
  export function createFromReadableStream<T>(stream: ReadableStream): Promise<T>;
}

declare module 'devjs-server-dom-parcel/server.edge' {
...
declare module '@parcel/runtime-rsc' {
  import {JSX} from 'devjs';
  export function Resources(): JSX.Element;
}

declare module 'devjs-dom/server.edge' {
  export * from 'devjs-dom/server';
}
