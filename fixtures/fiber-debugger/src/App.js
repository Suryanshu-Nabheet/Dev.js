import Devjs, {Component} from 'devjs';
import Draggable from 'devjs-draggable';
import DevjsNoop from 'devjs-noop-renderer';
import Editor from './Editor';
import Fibers from './Fibers';
import describeFibers from './describeFibers';

// The only place where we use it.
const DevjsFiberInstrumentation =
  DevjsNoop.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
    .DevjsFiberInstrumentation;
...
DevjsNoop.render(<div>Hello</div>);
DevjsNoop.flush();

log('Render <h1>Goodbye</h1>');
DevjsNoop.render(<h1>Goodbye</h1>);
DevjsNoop.flush();
`;
...
class App extends Component {
  ...
  runCode(code) {
    ...
    DevjsFiberInstrumentation.debugTool = null;
    DevjsNoop.render(null);
    DevjsNoop.flush();
    DevjsFiberInstrumentation.debugTool = {
