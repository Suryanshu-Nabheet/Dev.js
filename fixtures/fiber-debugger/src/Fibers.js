...
import {Motion, spring} from 'devjs-motion';
import dagre from 'dagre';
// import prettyFormat from 'pretty-format';
// import devjsElement from 'pretty-format/plugins/DevjsElement';
...
function Graph(props) {
  ...
  var edgeLabels = {};
  Devjs.Children.forEach(props.children, function (child) {
    if (!child) {
      return;
    }
    ...
    return (
      <Motion
        ...
        {interpolatedStyle => {
          ...
          return Devjs.cloneElement(edge.label, {
            points,
            id: edge.label.key,
        ...
        {items.map(fiber => [
          <Vertex
            ...
            <div
              ...
              title={
                /*prettyFormat(fiber, { plugins: [devjsElement ]})*/
