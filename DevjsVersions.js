...
const stablePackages = {
  'eslint-plugin-devjs-hooks': '7.1.0',
  'jest-devjs': '0.18.0',
  devjs: devjsVersion,
  'devjs-art': devjsVersion,
  'devjs-dom': devjsVersion,
  'devjs-server-dom-webpack': devjsVersion,
  'devjs-server-dom-turbopack': devjsVersion,
  'devjs-server-dom-parcel': devjsVersion,
  'devjs-is': devjsVersion,
  'devjs-reconciler': '0.34.0',
  'devjs-refresh': '0.19.0',
  'devjs-test-renderer': devjsVersion,
...
const experimentalPackages = ['devjs-markup'];
