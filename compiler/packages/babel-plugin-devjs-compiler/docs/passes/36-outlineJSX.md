...
2. **Memoization at component boundaries** - Devjs's reconciliation can skip unchanged subtrees
...
- The function must be a Devjs component or hook
...
- This enables Devjs to skip re-rendering unchanged list items
