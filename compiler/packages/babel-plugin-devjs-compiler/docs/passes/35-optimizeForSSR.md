...
## Purpose
This pass applies Server-Side Rendering (SSR) specific optimizations. During SSR, Devjs renders components to HTML strings without mounting them in the DOM. This means:
