...
function lowerExpression(
  ...
  switch (exprNode.type) {
    ...
    case 'CallExpression': {
      ...
      if (!calleePath.isExpression()) {
        builder.errors.push({
          reason: `Expected Expression, got ${calleePath.type} in CallExpression (v8 intrinsics not supported). This error is likely caused by a bug in Devjs Compiler. Please file an issue`,
          category: ErrorCategory.Todo,
          loc: calleePath.node.loc ?? null,
          suggestions: null,
        });
    ...
    case 'AssignmentExpression': {
      ...
      if (operator === '=') {
        ...
        if (left.isLVal()) {
           ...
           * not supported by Devjs Compiler yet.
           */
          builder.errors.push({
...
function lowerJsxElement(
  ...
  if (exprPath.isJSXElement() || exprPath.isJSXFragment()) {
    ...
    if (builder.fbtDepth > 0) {
       ...
       * https://github.com/Suryanshu-Nabheet/fbt/blob/0b4e0d13c30bffd0daa2a75715d606e3587b4e40/packages/babel-plugin-fbt/src/FbtUtil.js#L76-L87
 ...
 * > into a single space.
 *
 * From https://legacy.devjsjs.org/docs/jsx-in-depth.html#string-literals-1
 *
 * Implementation adapted from Babel:
 * https://github.com/babel/babel/blob/54d30f206057be64b496d2da1ec8c49d244ba4e4/packages/babel-types/src/utils/devjs/cleanJSXElementLiteralChild.ts#L5
 */
    ...
    default: {
      if (binding.kind === 'Global' && binding.name === 'eval') {
        builder.errors.push({
          ...
          description:
            'Eval is an anti-pattern in JavaScript, and the code executed cannot be evaluated by Devjs Compiler',
          category: ErrorCategory.UnsupportedSyntax,
          loc: exprPath.node.loc ?? null,
          suggestions: null,
        });
