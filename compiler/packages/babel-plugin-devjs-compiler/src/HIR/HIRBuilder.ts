  ...
  resolveBinding(node: t.Identifier): Identifier {
    ...
    if (node.name === 'this') {
      CompilerError.throwDiagnostic({
        ...
        description:
          'Devjs Compiler does not support compiling functions that use `this`',
        details: [
          {
            kind: 'error',
 ...
 * same metadata properties as the original place (effect, devjsive flag, type)
