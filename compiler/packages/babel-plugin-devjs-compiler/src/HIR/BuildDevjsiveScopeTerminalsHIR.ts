 ...
 * Given a function whose devjsive scope ranges have been correctly aligned and merged,
 * this pass rewrites blocks to introduce DevjsiveScopeTerminals and their fallthrough blocks.
 * e.g.
 * ```js
 * // source
 * [0] ...
...
export function buildDevjsiveScopeTerminalsHIR(fn: HIRFunction): void {
  /**
   * Step 1:
...
function handleRewrite(
  ...
  const terminal: DevjsiveScopeTerminal | GotoTerminal =
