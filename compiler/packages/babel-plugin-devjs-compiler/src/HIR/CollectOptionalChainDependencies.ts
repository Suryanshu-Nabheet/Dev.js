...
export type OptionalChainSidemap = {
   ...
   * outer phi nodes.
   */
  temporariesReadInOptional: ReadonlyMap<IdentifierId, DevjsiveScopeDependency>;
  /**
   ...
   * ```
   */
  hoistableObjects: ReadonlyMap<BlockId, DevjsiveScopeDependency>;
};
...
type OptionalTraversalContext = {
  ...
  temporariesReadInOptional: Map<IdentifierId, DevjsiveScopeDependency>;
  hoistableObjects: Map<BlockId, DevjsiveScopeDependency>;
};
...
function traverseOptionalBlock(
  ...
  let baseObject: DevjsiveScopeDependency;
  if (maybeTest.terminal.kind === 'branch') {
    ...
    baseObject = {
      ...
      devjsive: maybeTest.instructions[0].value.place.devjsive,
      path,
  ...
  const load: DevjsiveScopeDependency = {
    identifier: baseObject.identifier,
    devjsive: baseObject.devjsive,
    path: [
      ...baseObject.path,
      {
