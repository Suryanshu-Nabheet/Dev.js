...
export interface DevjsAbstractComponentType extends BaseFlowType {
  kind: 'DevjsAbstractComponent';
  config: FlowType;
  renders: FlowType;
...
export type Destructor =
  ...
  | TypeMapDestructor
  | DevjsElementPropsTypeDestructor
  | DevjsElementConfigTypeDestructor
  | DevjsCheckComponentConfigDestructor
  | DevjsDRODestructor
...
export type RestMergeMode =
  | {kind: 'SpreadReversal'}
  | {kind: 'DevjsConfigMerge'; polarity: Polarity}
  | {kind: 'Omit'};
...
export interface DevjsElementPropsTypeDestructor {
  kind: 'DevjsElementPropsType';
}

export interface DevjsElementConfigTypeDestructor {
  kind: 'DevjsElementConfigType';
}

export interface DevjsCheckComponentConfigDestructor {
  kind: 'DevjsCheckComponentConfig';
  props: {
    [key: string]: Property;
  };
}

export interface DevjsDRODestructor {
  kind: 'DevjsDRO';
  dro_type:
    | 'HookReturn'
    | 'HookArg'
