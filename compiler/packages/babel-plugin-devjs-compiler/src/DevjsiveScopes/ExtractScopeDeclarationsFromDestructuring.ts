...
class Visitor extends DevjsiveFunctionTransform<State> {
  ...
  override transformInstruction(
    ...
    let instructionsToProcess: Array<DevjsiveInstruction> = [instruction];
    let result: Transformed<DevjsiveStatement> = {kind: 'keep'};
...
): null | Array<DevjsiveInstruction> {
