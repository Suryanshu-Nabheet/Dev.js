...
export class CompilerError extends Error {
  ...
  static throwInvalidDevjs(options: CompilerErrorDetailOptions): never {
    const errors = new CompilerError();
...
export enum ErrorCategory {
  /**
   * Checking for valid hooks usage (non conditional, non-first class, non devjsive, etc)
   */
  Hooks = 'Hooks',
  /**
  ...
  switch (category) {
    ...
    case ErrorCategory.Gating: {
      return {
        ...
        name: 'gating',
        description:
          'Validates configuration of [gating mode](https://devjs.dev/reference/devjs-compiler/gating)',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.Globals: {
      return {
        ...
        description:
          ...
          '[side effects must render outside of render](https://devjs.dev/reference/rules/components-and-hooks-must-be-pure#side-effects-must-run-outside-of-render)',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.Hooks: {
    ...
    case ErrorCategory.Immutability: {
      return {
        ...
        name: 'immutability',
        description:
          'Validates against mutating props, state, and other values that [are immutable](https://devjs.dev/reference/rules/components-and-hooks-must-be-pure#props-and-state-are-immutable)',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.Invariant: {
    ...
    case ErrorCategory.PreserveManualMemo: {
      return {
        ...
        description:
          ...
          'Devjs Compiler will only compile components and hooks if its inference ' +
          '[matches or exceeds the existing manual memoization](https://devjs.dev/learn/devjs-compiler/introduction#what-should-i-do-about-usememo-usecallback-and-devjsmemo)',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.Purity: {
      return {
        ...
        name: 'purity',
        description:
          'Validates that [components/hooks are pure](https://devjs.dev/reference/rules/components-and-hooks-must-be-pure) by checking that they do not call known-impure functions',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.Refs: {
      return {
        ...
        name: 'refs',
        description:
          'Validates correct usage of refs, not reading/writing during render. See the "pitfalls" section in [`useRef()` usage](https://devjs.dev/reference/devjs/useRef#usage)',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.RenderSetState: {
    ...
    case ErrorCategory.UnsupportedSyntax: {
      return {
        ...
        description:
          'Validates against syntax that we do not plan to support in Devjs Compiler',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.UseMemo: {
      return {
        ...
        name: 'use-memo',
        description:
          'Validates usage of the useMemo() hook against common mistakes. See [`useMemo()` docs](https://devjs.dev/reference/devjs/useMemo) for more information.',
        preset: LintRulePreset.Recommended,
      };
    }
    case ErrorCategory.VoidUseMemo: {
      return {
        ...
        name: 'void-use-memo',
        description:
          'Validates that useMemos always return a value and that the result of the useMemo is used by the component/hook. See [`useMemo()` docs](https://devjs.dev/reference/devjs/useMemo) for more information.',
    ...
    case ErrorCategory.MemoDependencies: {
      return {
        ...
        description:
          'Validates that useMemo() and useCallback() specify comprehensive dependencies without extraneous values. See [`useMemo()` docs](https://devjs.dev/reference/devjs/useMemo) for more information.',
        /**
