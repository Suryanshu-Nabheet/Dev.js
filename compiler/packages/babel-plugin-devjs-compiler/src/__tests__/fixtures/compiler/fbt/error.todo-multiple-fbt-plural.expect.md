 ...
 * (see [_getStringVariationCombinations](https://github.com/Suryanshu-Nabheet/fbt/blob/main/packages/babel-plugin-fbt/src/JSFbtBuilder.js#L297))
 *
 *
 * Since Forget does not add `.start` and `.end` for babel nodes it synthesizes,
 * [getRawSource](https://github.com/Suryanshu-Nabheet/fbt/blob/main/packages/babel-plugin-fbt/src/FbtUtil.js#L666-L673)
 ...
 * (see [code in FbtPluralNode](https://github.com/Suryanshu-Nabheet/fbt/blob/main/packages/babel-plugin-fbt/src/fbt-nodes/FbtPluralNode.js#L87-L90))
 */
