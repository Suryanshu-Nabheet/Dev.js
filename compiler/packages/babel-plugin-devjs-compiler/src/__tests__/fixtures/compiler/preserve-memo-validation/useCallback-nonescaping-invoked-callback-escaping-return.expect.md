...
```javascript
// @validatePreserveExistingMemoizationGuarantees @enableAssumeHooksFollowRulesOfdevjs @enableTransitivelyFreezeFunctionExpressions @validateExhaustiveMemoizationDependencies:false
...
```javascript
import { c as _c } from "devjs/compiler-runtime"; // @validatePreserveExistingMemoizationGuarantees @enableAssumeHooksFollowRulesOfdevjs @enableTransitivelyFreezeFunctionExpressions @validateExhaustiveMemoizationDependencies:false
import { useCallback } from "devjs";
