...
```javascript
// @validatePreserveExistingMemoizationGuarantees @enableAssumeHooksFollowRulesOfdevjs @enableTransitivelyFreezeFunctionExpressions
...
```javascript
import { c as _c } from "devjs/compiler-runtime"; // @validatePreserveExistingMemoizationGuarantees @enableAssumeHooksFollowRulesOfdevjs @enableTransitivelyFreezeFunctionExpressions
import { useCallback } from "devjs";
