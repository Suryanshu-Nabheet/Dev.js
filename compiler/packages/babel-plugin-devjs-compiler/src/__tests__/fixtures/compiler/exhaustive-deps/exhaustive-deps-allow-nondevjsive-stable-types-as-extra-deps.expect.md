...
function useFoo() {
  ...
  useEffect(() => {
    ...
    // intentionally adding unnecessary deps on nondevjsive stable values
...
```javascript
import { c as _c } from "devjs/compiler-runtime"; // @validateExhaustiveMemoizationDependencies @validateExhaustiveEffectDependencies:"all"
import {
  useCallback,
  useTransition,
  useState,
