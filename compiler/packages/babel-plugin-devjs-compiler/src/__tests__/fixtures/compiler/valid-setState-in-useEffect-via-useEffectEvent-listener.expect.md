...
```javascript
import { c as _c } from "devjs/compiler-runtime"; // @validateNoSetStateInEffects @loggerTestOnly @compilationMode:"infer"
import { useEffect, useEffectEvent, useState } from "devjs";
...
### Eval output
(kind: exception) (0 , _devjs.useEffectEvent) is not a function