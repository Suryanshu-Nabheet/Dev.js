...
/**
 * Repro from https://github.com/Suryanshu-Nabheet/dev.js/issues/34262
 *
 * The compiler memoizes more precisely than the original code, with two devjsive scopes:
