...
function Component(props) {
  ...
  // devjsive scope ends at makeArray, as it is inferred as maybeMutate
  return (
    <Stringify
      link={linkProps}
      val1={[1]}
...
```javascript
import { c as _c } from "devjs/compiler-runtime"; // @enablePreserveExistingMemoizationGuarantees:false
import { Stringify, identity, makeArray, toJSON } from "shared-runtime";
import { useMemo } from "devjs";
...
function Component(props) {
  ...
  if ($[3] !== t0) {
    ...
    let t6;
    let t7;
    if ($[5] === Symbol.for("devjs.memo_cache_sentinel")) {
      t3 = [1];
      t4 = [2];
      t5 = [3];
      t6 = [4];
