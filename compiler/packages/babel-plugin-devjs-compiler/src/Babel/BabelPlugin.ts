...
const ENABLE_devjs_COMPILER_TIMINGS =
  process.env['ENABLE_devjs_COMPILER_TIMINGS'] === '1';

/*
 * The Devjs Forget Babel Plugin
 * @param {*} _babel
 * @returns
 */
export default function BabelPluginDevjsCompiler(
      ...
      Program: {
        enter(prog, pass): void {
          try {
            ...
            if (ENABLE_devjs_COMPILER_TIMINGS === true) {
