...
import {BabelFn, getdevjsCompilerRuntimeModule} from './Program';
...
export class ProgramContext {
  ...
  constructor({
    ...
    this.code = code;
    this.devjsRuntimeModule = getdevjsCompilerRuntimeModule(opts.target);
  ...
  addMemoCacheImport(): NonLocalImportSpecifier {
    return this.addImportSpecifier(
      {
        source: this.devjsRuntimeModule,
 ...
 * but not `import * as devjs from <moduleName>;`
