...
export default function AnnotateDevjsCodeBabelPlugin(
  _babel: typeof BabelCore,
): BabelCore.PluginObj {
  return {
    name: 'annotate-devjs-code',
    visitor: {
      Program(prog): void {
        annotate(prog);
      },
...
function annotate(program: NodePath<t.Program>): void {
  function traverseFn(fn: BabelFn): void {
    ...
    if (t.isBlockStatement(body)) {
      body.body.unshift(buildTypeOfDevjsForget());
    }
  }
...
function buildTypeOfDevjsForget(): t.Statement {
  // typeof globalThis[Symbol.for("devjs_forget")]
...
/**
 * COPIED FROM babel-plugin-devjs-compiler/src/Entrypoint/BabelUtils.ts
 */
