...
import type {TypeConfig} from 'babel-plugin-devjs-compiler/src/HIR/TypeSchema';
...
export function makeSharedRuntimeTypeProvider({
  ...
  return function sharedRuntimeTypeProvider(
    ...
    } else if (moduleName === 'devjsCompilerKnownIncompatibleTest') {
      /**
    ...
    } else if (moduleName === 'devjsCompilerTest') {
      /**
