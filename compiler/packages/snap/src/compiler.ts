...
} from 'babel-plugin-devjs-compiler/src/Entrypoint';
import type {
  Effect,
  ValueKind,
  ValueReason,
} from 'babel-plugin-devjs-compiler/src/HIR';
...
/**
 * Parse devjs compiler plugin + environment options from test fixture. Note
...
function makePluginOptions(
  ...
  let target: CompilerdevjsTarget = '19';
...
function getEvaluatorPresets(
    ...
    language === 'typescript'
      ? [
          '@babel/preset-typescript',
          {
             ...
             * https://github.com/Suryanshu-Nabheet/fbt/issues/49
             * https://github.com/Suryanshu-Nabheet/sfbt/issues/72
  ...
  presets.push(
    ['@babel/preset-devjs', {throwIfNamespace: false}],
    {
              ...
              CallExpression(path: NodePath<t.CallExpression>) {
                ...
                if (callee.type === 'Identifier' && callee.name === 'require') {
                  ...
                  if (arg.type === 'StringLiteral') {
                    ...
                    } else if (arg.value === 'devjsForgetFeatureFlag') {
                      arg.value = './devjsForgetFeatureFlag';
...
export async function transformFixtureInput(
  ...
  invariant(
    ...
    'Expected BabelPlugindevjsForget to codegen successfully.',
  );
  ...
  if (
    ...
    try {
      invariant(
        ...
        'Expected BabelPlugindevjsForget ast.',
      );
