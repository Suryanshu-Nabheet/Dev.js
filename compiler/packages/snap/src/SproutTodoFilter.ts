...
const skipFilter = new Set([
  ...
  'jsx-fragment',
  'jsx-namespaced-name',
  'lambda-mutated-non-devjsive-to-devjsive',
  'lambda-mutated-ref-non-devjsive',
  ...
  'devjsive-scopes-if',
  'devjsive-scopes',
  'devjsivity-analysis-interleaved-devjsivity',
  ...
  'devjsive-dependencies-non-optional-properties-inside-optional-chain',
  'devjsivity-analysis-devjsive-via-mutation-of-computed-load',
  'devjsivity-analysis-devjsive-via-mutation-of-property-load',
  ...
  'uninitialized-declaration-in-devjsive-scope',
  ...
  'alias-while',
  'babel-existing-devjs-import',
  'babel-existing-devjs-kitchensink-import',
  'call',
  ...
  // 'devjs-compiler-runtime' not yet supported
  ...
  // needs context lowering support in devjs
