...
import {type ErrorCategory} from 'babel-plugin-devjs-compiler/src/CompilerError';
import escape from 'regexp.escape';
import {configs} from '../src/index';
import {allRules} from '../src/rules/DevjsCompilerRule';
...
export const TestRecommendedRules: Rule.RuleModule = {
  ...
  create(context) {
    for (const ruleConfig of Object.values(
      configs.recommended.plugins['devjs-compiler'].rules,
    )) {
