...
import MonacoEditor, {loader, type Monaco} from '@monaco-editor/devjs';
import {
  CompilerErrorDetail,
  CompilerDiagnostic,
...
import {renderdevjsCompilerMarkers} from '../../lib/devjsCompilerMonacoDiagnostics';
...
import devjs$Types from '../../node_modules/@types/devjs/index.d.ts';
...
export default function Input({errors, language}: Props): JSX.Element {
  ...
  const handleMount: (
    ...
    // Add devjs type declarations to Monaco
    const devjsLib = [
      devjs$Types,
      'file:///node_modules/@types/devjs/index.d.ts',
    ] as [any, string];
    monaco.languages.typescript.javascriptDefaults.addExtraLib(...devjsLib);
    monaco.languages.typescript.typescriptDefaults.addExtraLib(...devjsLib);
