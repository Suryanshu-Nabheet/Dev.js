...
import compilerTypeDefs from 'babel-plugin-devjs-compiler/dist/index.d.ts';
...
function ExpandedEditor({
  ...
  const handleMount: (
    ...
    // Add the babel-plugin-devjs-compiler type definitions to Monaco
    monaco.languages.typescript.typescriptDefaults.addExtraLib(
      //@ts-expect-error - compilerTypeDefs is a string
      compilerTypeDefs,
      'file:///node_modules/babel-plugin-devjs-compiler/dist/index.d.ts',
    );
    monaco.languages.typescript.typescriptDefaults.setCompilerOptions({
      ...
      jsx: monaco.languages.typescript.JsxEmit.devjs,
    });
  };
