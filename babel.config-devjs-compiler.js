...
/**
 * HACK: @poteto devjs Compiler inlines Zod in its build artifact. Zod spreads values passed to .map
 ...
 *
 * I will remove this hack later when we move eslint-plugin-devjs-hooks into the compiler directory.
 **/
